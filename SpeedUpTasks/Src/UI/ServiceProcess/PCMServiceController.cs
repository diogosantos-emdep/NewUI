...
{
    public class PCMServiceController : IPCMService
    {
        string serviceAddress = "";
        ServiceBehaviorAttribute serviceb;
        Binding binding;
        EndpointAddress endPointAddress;
        ChannelFactory<IPCMService> factory = null;

        public PCMServiceController(string serviceUrl)
        {
            serviceAddress = "http://" + serviceUrl + "/PCMService.svc";
        ...
        public List<CatalogueItem> GetAllCatalogueItems()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllCatalogueItems();
            }
        ...
        public List<Template> GetAllTemplates()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllTemplates();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionTypes> GetAllDetectionTypes()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllDetectionTypes();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Detections> GetAllDetectionList()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllDetectionList();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Options> GetAllOptionList()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllOptionList();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<SpareParts> GetAllSparePartList()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllSparePartList();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<RegionsByCustomer> GetCustomersWithRegions()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCustomersWithRegions();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public CatalogueItem AddCatalogueItem(CatalogueItem catalogueItemModel)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.AddCatalogueItem(catalogueItemModel);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool UpdateCatalogueItem(CatalogueItem catalogueItemModel)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.UpdateCatalogueItem(catalogueItemModel);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeletedCatalogueItem(UInt32 idCatalogueItem)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeletedCatalogueItem(idCatalogueItem);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public string GetLatestCatalogueItemCode()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetLatestCatalogueItemCode();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ProductTypes> GetProductTypesByTemplate(UInt64 idTemplate)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypesByTemplate(idTemplate);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public CatalogueItem GetCatalogueItemByIdCatalogueItem(UInt32 IdCatalogueItem)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCatalogueItemByIdCatalogueItem(IdCatalogueItem);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<TestTypes> GetAllTestTypes()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllTestTypes();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public ProductTypes AddProductType(ProductTypes productTypes)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.AddProductType(productTypes);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool UpdateProductType(ProductTypes productTypes)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.UpdateProductType(productTypes);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionDetails AddDetection(DetectionDetails detectionDetails)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.AddDetection(detectionDetails);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool UpdateDetection(DetectionDetails detectionDetails)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.UpdateDetection(detectionDetails);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public ProductTypes GetProductTypeByIdCpType(UInt64 IdCpType, UInt64 IdTemplate)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeByIdCpType(IdCpType, IdTemplate);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionDetails GetDetectionByIdDetection(UInt32 IdDetection)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionByIdDetection(IdDetection);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeleteProductTypeImage(ProductTypeImage productTypeImage)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeleteProductTypeImage(productTypeImage);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ProductTypeImage> GetProductTypeImagesByIdProductType(UInt64 IdProductType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeImagesByIdProductType(IdProductType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public ProductTypeImage GetProductTypeImagesByIdProductTypeImage(UInt64 IdProductTypeImage)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeImagesByIdProductTypeImage(IdProductTypeImage);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeleteProductTypeAttachedDoc(ProductTypeAttachedDoc productTypeAttachedDoc)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeleteProductTypeAttachedDoc(productTypeAttachedDoc);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ProductTypeAttachedDoc> GetProductTypeAttachedDocsByIdProductType(UInt64 IdProductType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeAttachedDocsByIdProductType(IdProductType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public ProductTypeAttachedDoc GetProductTypeAttachedDocsByIdProductTypeAttachedDoc(Int32 IdProductTypeAttachedDoc)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeAttachedDocsByIdProductTypeAttachedDoc(IdProductTypeAttachedDoc);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<CatalogueItemAttachedDoc> GetCatalogueItemAttachedDocsByIdCatalogueItem(UInt32 IdCatalogueItem)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCatalogueItemAttachedDocsByIdCatalogueItem(IdCatalogueItem);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public CatalogueItemAttachedDoc GetCatalogueItemAttachedDocsById(UInt32 IdCatalogueItemAttachedDoc)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCatalogueItemAttachedDocsById(IdCatalogueItemAttachedDoc);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionAttachedDoc> GetDetectionAttachedDocsByIdDetection(UInt32 IdDetection)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionAttachedDocsByIdDetection(IdDetection);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionAttachedDoc GetDetectionAttachedDocsById(UInt32 IdDetectionAttachedDoc)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionAttachedDocsById(IdDetectionAttachedDoc);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<CatalogueItemAttachedLink> GetCatalogueItemAttachedLinksByIdCatalogueItem(UInt32 IdCatalogueItem)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCatalogueItemAttachedLinksByIdCatalogueItem(IdCatalogueItem);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public CatalogueItemAttachedLink GetCatalogueItemAttachedLinkById(UInt32 IdCatalogueItemAttachedLink)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetCatalogueItemAttachedLinkById(IdCatalogueItemAttachedLink);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ProductTypeAttachedLink> GetProductTypeAttachedLinksByIdProductType(UInt64 IdCPType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeAttachedLinksByIdProductType(IdCPType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public ProductTypeAttachedLink GetProductTypeAttachedLinkById(UInt32 IdCPTypeAttachedLink)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypeAttachedLinkById(IdCPTypeAttachedLink);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionAttachedLink> GetDetectionAttachedLinksByIdDetection(UInt32 IdDetection)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionAttachedLinksByIdDetection(IdDetection);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionAttachedLink GetDetectionAttachedLinkById(UInt32 IdDetectionAttachedLink)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionAttachedLinkById(IdDetectionAttachedLink);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public string GetLatestProuductTypeReference()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetLatestProuductTypeReference();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeletedProductType(UInt64 IdCPType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeletedProductType(IdCPType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DefaultWayType> GetAllDefaultWayTypeList()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllDefaultWayTypeList();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionImage> GetDetectionImagesByIdDetection(UInt32 IdDetection)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionImagesByIdDetection(IdDetection);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionImage GetDetectionImagesByIdDetectionImage(UInt32 IdDetectionImage)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionImagesByIdDetectionImage(IdDetectionImage);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionGroup> GetDetectionGroupsByDetectionType(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionGroupsByDetectionType(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionOrderGroup> GetDetectionOrderGroupsWithDetections(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionOrderGroupsWithDetections(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionGroup> GetDetectionGroupsList(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionGroupsList(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public DetectionGroup GetDetectionGroupsByIdGroup(UInt32 IdGroup)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionGroupsByIdGroup(IdGroup);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public string GetDetectionsConcatByIdGroup(UInt32 IdGroup)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionsConcatByIdGroup(IdGroup);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionOrderGroup> GetDetectionOrderGroup(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionOrderGroup(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Detections> GetDetectionGroups(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetDetectionGroups(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Options> GetOptionGroups(UInt32 IdDetectionType)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetOptionGroups(IdDetectionType);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Detections> GetAllDetectionsWithGroups()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllDetectionsWithGroups();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Options> GetAllOptionsWithGroups()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllOptionsWithGroups();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetArticlesByCategory(uint IdArticleCategory)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetArticlesByCategory(IdArticleCategory);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<PCMArticleCategory> GetPCMArticleCategories()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticleCategories();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetAllPCMArticles()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllPCMArticles();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetPCMArticlesByCategory(uint IdArticleCategory)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticlesByCategory(IdArticleCategory);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsUpdatePCMArticleCategoryInArticle(uint IdPCMArticleCategory, List<Articles> ArticleList)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsUpdatePCMArticleCategoryInArticle(IdPCMArticleCategory, ArticleList);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ArticleCategories> GetActiveArticleCategories()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetActiveArticleCategories();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetAllActiveArticles()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllActiveArticles();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetActiveArticlesByCategory(uint IdArticleCategory)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetActiveArticlesByCategory(IdArticleCategory);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<PCMArticleCategory> GetActivePCMArticleCategories()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetActivePCMArticleCategories();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetAllActivePCMArticles()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllActivePCMArticles();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetActivePCMArticlesByCategory(uint IdArticleCategory)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetActivePCMArticlesByCategory(IdArticleCategory);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public PCMArticleCategory AddPCMArticleCategory(PCMArticleCategory pcmArticleCategory, List<PCMArticleCategory> pcmArticleCategoryList)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.AddPCMArticleCategory(pcmArticleCategory, pcmArticleCategoryList);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsUpdatePCMArticleCategory(PCMArticleCategory pcmArticleCategory, List<PCMArticleCategory> pcmArticleCategoryList)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsUpdatePCMArticleCategory(pcmArticleCategory, pcmArticleCategoryList);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public PCMArticleCategory GetPCMArticleCategoryById(uint idPCMArticleCategory)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticleCategoryById(idPCMArticleCategory);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public Articles GetArticleByIdArticle(UInt32 IdArticle)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetArticleByIdArticle(IdArticle);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsUpdatePCMArticleCategoryInArticleWithStatus(uint IdPCMArticleCategory, Articles Article)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsUpdatePCMArticleCategoryInArticleWithStatus(IdPCMArticleCategory, Article);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ProductTypesTemplate> GetProductTypesWithTemplate()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetProductTypesWithTemplate();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeletedDetection(UInt32 IdDetection)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeletedDetection(IdDetection);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DetectionDetails> GetAllDetectionsWaysOptionsSpareParts()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllDetectionsWaysOptionsSpareParts();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<ArticleDocument> GetArticleAttachmentByIdArticle(UInt32 idArticle)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetArticleAttachmentByIdArticle(idArticle);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsUpdatedPCMArticleCategoryOrder(List<PCMArticleCategory> pcmArticleCategoryList, uint? IdModifier)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsUpdatedPCMArticleCategoryOrder(pcmArticleCategoryList, IdModifier);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsDeletePCMArticleCategory(List<PCMArticleCategory> pcmArticleCategoryList)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsDeletePCMArticleCategory(pcmArticleCategoryList);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool IsUpdatePCMArticleCategoryInArticleWithStatus_V2060(uint IdPCMArticleCategory, Articles Article)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.IsUpdatePCMArticleCategoryInArticleWithStatus_V2060(IdPCMArticleCategory, Article);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<PCMArticleCategory> GetPCMArticleCategories_V2060()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticleCategories_V2060();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Articles> GetAllPCMArticles_V2060()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetAllPCMArticles_V2060();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public Articles GetArticleByIdArticle_V2060(UInt32 IdArticle)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetArticleByIdArticle_V2060(IdArticle);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<PCMArticleCategory> GetPCMArticlesWithCategory_V2060()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticlesWithCategory_V2060();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<PCMArticleCategory> GetPCMArticlesWithCategoryForReference_V2060()
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.GetPCMArticlesWithCategoryForReference_V2060();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool AddDeletePCMArticle(uint IdPCMArticleCategory, List<Articles> ArticleList, int IdUser)
        {
            try
            {
                factory = new ChannelFactory<IPCMService>(binding, endPointAddress);
                IPCMService channel = factory.CreateChannel();
                return channel.AddDeletePCMArticle(IdPCMArticleCategory, ArticleList, IdUser);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
