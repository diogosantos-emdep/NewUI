...
namespace Emdep.Geos.UI.Helper
{
    ...
    public enum SettingsTypeSAM
    {
        ...
        Description, PercentText,  DeliveryDate, DeliveryWeek, OthersFields, Source, BusinessUnit, OEM, Hidden, Fixed,Project,IsChecked, OfferCode, PO,Category1, Category2, OfferOwner,OfferedTo,Type, Modules, Group,Plant,Empty
    }
}
