...
{
    [DataContract]
    public class DetectionImage : ModelBase, IDisposable
    {
        #region Fields

        UInt32 idDetectionImage;
        UInt32 idDetection;
        ...
        [DataMember]
        public UInt32 IdDetectionImage
        {
            get
            {
                return idDetectionImage;
            }

            set
            {
                idDetectionImage = value;
                OnPropertyChanged("IdDetectionImage");
            }
        }
        ...
        [DataMember]
        public byte[] DetectionImageInBytes
        {
            get
            {
                return detectionImageInBytes;
            }

            set
            {
                detectionImageInBytes = value;
                OnPropertyChanged("DetectionImageInBytes");
            }
        }
