    ...
    public class CustomFilterEditorViewModel : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public CustomFilterEditorViewModel()
        {
            try
            {
                ...
                CustomFilterEditorAcceptCommand = new DelegateCommand<object>(AcceptCustomFilterEditor);
                CustomFilterEditorCancelCommand = new DelegateCommand<object>(CancelCustomFilterEditor);
        ...
        #region Methods
        private void AcceptCustomFilterEditor(object obj)
        {
            try
            {
        ...
        private void CancelCustomFilterEditor(object obj)
        {
            try
            {
