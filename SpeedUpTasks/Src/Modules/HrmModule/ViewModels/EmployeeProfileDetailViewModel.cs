...
{
    public class EmployeeProfileDetailViewModel : INotifyPropertyChanged, IDataErrorInfo
    {
        #region TaskLog
        ...
        private void OpenEmployeeLeaveDocument(object obj)
        {
            try
            {
                ...
                //if (FileInBytes != null)
                //{
                //    byte[] EmployeeExitAttachmentBytes = FileInBytes;
                //    EmployeeDocumentView employeeDocumentView = new EmployeeDocumentView();
                //    EmployeeDocumentViewModel employeeDocumentViewModel = new EmployeeDocumentViewModel();
                //    if (EmployeeExitAttachmentBytes != null)
                //    {
                //        employeeDocumentViewModel.OpenPdfFromBytes(EmployeeExitAttachmentBytes, FileName);
                //        employeeDocumentView.DataContext = employeeDocumentViewModel;
                //        employeeDocumentView.ShowDialog();
                //    }
                //    else
        ...
        public void Init(Employee emp, long SelectedPeriod, string companyIds)
        {
            try
            {
                ...
                SelectedLocationIndex = LocationList.FindIndex(x => x.IdCompany == EmployeeDetail.IdCompanyLocation);
                ...
                else
                {
                    ...
                    {
                        EmployeeJobDescriptionList.ToList().ForEach(a => { a.IsMainVisible = Visibility.Hidden; });
                    }
                }                 
                ...
                if (EmployeeContractSituationList.Count > 0)
                {
                    ...
                    foreach (EmployeeContractSituation employeeContractSituation in EmployeeContractSituationList)
                    {
                        ...
                        else if (employeeContractSituation.ContractSituationEndDate == null)
                        {
                            ...
                            Period Daysperiod = Period.Between(start, end);
                            days = days + Daysperiod.Days;
                        }
                        else
                        {
                            if (employeeContractSituation.ContractSituationEndDate > GeosApplication.Instance.ServerDateTime.Date)
                            {
                                LocalDate start = new LocalDate(employeeContractSituation.ContractSituationStartDate.Value.Year, employeeContractSituation.ContractSituationStartDate.Value.Month, employeeContractSituation.ContractSituationStartDate.Value.Day);
                                LocalDate end = new LocalDate(GeosApplication.Instance.ServerDateTime.Year, GeosApplication.Instance.ServerDateTime.Month, GeosApplication.Instance.ServerDateTime.Day).PlusDays(1);
                                // LocalDate end = new LocalDate(2020, 02, 13).PlusDays(1);
                                Period period = Period.Between(start, end, PeriodUnits.Months);
                                month = month + period.Months;
        ...
        private void FillLocationList()
        {
            try
            {
                ...
                LocationList.AddRange(tempList);
        ...
        public void OnTextEditValueChanging(EditValueChangingEventArgs e)
       {
            ...
            try
            {
                ...
                if (empContact != null)
                {
                    ...
                    if (addContactInformationViewModel.IsSave == true)
                    {
                        ...
                        {
                            var existEmpProfessionalContact = UpdatedEmployeeProfessionalContactList.Where(x => x.IdEmployeeContact == empContact.IdEmployeeContact).FirstOrDefault();
        ...
        private void EditEmployeeContractSituation(object obj)
        {
            try
            {
                ...
                //[001]added
                if (SelectedContractSituationRow.IdEmployeeExitEvent != null
                    && EmployeeStatusList[SelectedEmpolyeeStatusIndex].IdLookupValue == 136)
                ...
                if (employeeExitEventObj != null)
                {
                    ...
                    if (employeeExitEventObj.ExitDate != null)
                    {
                        ...
                        if (employeeExitEventObj.IdExitEvent != 1)
                        {
                            ...
                            employeeExitEvent.MaxDate = employeeExitEventObj.ExitDate;

                            employeeExitEventObj.MinExitEventDate = employeeExitEvent.ExitDate;
                        }
        ...
        public void EditEmployee()
        {
            try
            {
               ...
               // List<EmployeeContractSituation> itemECSS = GetAllUpdatedEmployeeContracts.Where(a => a.ContractSituationEndDate >= DateTime.Now.Date || a.ContractSituationEndDate == null).ToList();
                ...
                EmployeeContractSituation EmpFirstContract = GetAllUpdatedEmployeeContracts.OrderBy(ec => ec.ContractSituationStartDate).FirstOrDefault();
               ...
               !employeeDetail.EmployeeExitEvents.Any(item2 => item1.IdExitEvent == item2.IdExitEvent)).ToList();
                ...
                if (SelectedEmpolyeeStatusIndex != -1)
                {
                    ...
                    {
                        EmployeeExitEvent employeeExitEvent = ExitEventList.Where(x => x.IsExist == true && x.ExitDate == null).FirstOrDefault();
                ...
                if (IsPhoto)
                {
                    ...
                    else
                    {
                        ...
                        if (!imageResult)
                        {
                            ...
                            isProfileImageChanged = true;
                            EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeChangeLogImage").ToString()) });
                        }
                    }
                }
                else
                ...
                if (employeeExitEventObj != null)
                {
                    if (employeeExitEventObj.ExitDate != null)
                    {
                        if (employeeExitEventObj.SelectedExitEventReasonIndex > 0)
                        {
                            ...
                            EmployeeContractSituation tempEmployeeContractSituation = EmployeeContractSituationList.LastOrDefault(x => x.ContractSituationEndDate == null || x.ContractSituationEndDate == employeeExitEventObj.ExitDate);
                            ...
                            ObservableCollection<EmployeeJobDescription> TempEmployeeJobDescriptionsList = new ObservableCollection<EmployeeJobDescription>(EmployeeTopFourJobDescriptionList.Where(x => x.JobDescriptionEndDate == null || x.JobDescriptionEndDate == employeeExitEventObj.ExitDate).ToList());
                    ...
                    if (UpdateEmployeeExitEventsList.Count > 0)
                    {
                        foreach (EmployeeExitEvent item in UpdateEmployeeExitEventsList)
                        {
                            if (item.TransactionOperation == ModelBase.TransactionOperations.Update)
                            {
                                ...
                                if (OldExitEvent != null)
                                {
                                    EmployeeContractSituation tempEmployeeContractSituation = EmployeeContractSituationList.LastOrDefault(x => x.IdEmployeeExitEvent == item.IdEmployeeExitEvent && (x.ContractSituationEndDate == null || x.ContractSituationEndDate == OldExitEvent.ExitDate));
                                    ...
                                    ObservableCollection<EmployeeJobDescription> TempEmployeeJobDescriptionsList = new ObservableCollection<EmployeeJobDescription>(EmployeeJobDescriptionList.Where(x => x.IdEmployeeExitEvent == item.IdEmployeeExitEvent && (x.JobDescriptionEndDate == null || x.JobDescriptionEndDate == OldExitEvent.ExitDate)).ToList());
                ...
                if (EmployeeDetail.FirstName != EmployeeUpdatedDetail.FirstName || EmployeeDetail.LastName != EmployeeUpdatedDetail.LastName)
                {
                    ...
                    {
                        MessageBoxResult result = CustomMessageBox.Show(string.Format(System.Windows.Application.Current.FindResource("EmployeeExist").ToString(), string.Join(",", employees.Select(em => em.FullName).ToList())), "Yellow", CustomMessageBox.MessageImagePath.Warning, MessageBoxButton.OKCancel);
        ...
        private void CustomShowFilterPopup(FilterPopupEventArgs e)
        {
            ...
            if (e.Column.FieldName == "RegularHoursCount")
            {
                ...
                foreach (var dataObject in EmployeeAnnualLeaveList)
                {
                    ...
                    {
                        Int32 Days = (Int32)dataObject.RegularHoursCount / (Int32)dataObject.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount;
                        Int32 Hours = (Int32)dataObject.RegularHoursCount % (Int32)dataObject.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount;
            ...
            else if (e.Column.FieldName == "Enjoyed")
            {
                ...
                foreach (var dataObject in EmployeeAnnualLeaveList)
                {
                    ...
                    {
                        Int32 Days = (Int32)dataObject.Enjoyed / (Int32)dataObject.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount;
                        Int32 Hours = (Int32)dataObject.Enjoyed % (Int32)dataObject.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount;
        ...
        private void PrintEmployeeProfileReport(object obj)
        {
            try
            {
                ...
                EmpProfileReport.xrLblEmpHireDate.Text = PrintEmployee.EmployeeContractSituations.Min(x => x.ContractSituationStartDate.Value).ToShortDateString();
                ...
                if (tempEmployeeJobDescription != null)
                    FileName = "ERF_" + tempEmployeeJobDescription.Company.Alias + "_" + tempEmployeeJobDescription.JobDescription.JobDescriptionCode + "_" + Regex.Replace(GeosApplication.Instance.ServerDateTime.ToString("d", CultureInfo), @"[^0-9a-zA-Z]+", "");
        ...
        private void AddAuthorizedLeave(object obj)
        {
            try
            {
                ...
                addAuthorizedLeaveViewModel.Init(EmployeeAnnualLeaveList);
        ...
        private void EditAuthorizedLeave(object obj)
        {
            try
            {
                ...
                if (AnnualLeave != null)
                {
                    ...
                    {
                        addAuthorizedLeaveViewModel.EditInit(SelectedEmployeeAnnualLeave, EmployeeAnnualLeaveList);
                    }
                    ...
                    if (addAuthorizedLeaveViewModel.IsSave)
                    {
                        ...
                        AnnualLeave.Enjoyed = addAuthorizedLeaveViewModel.UpdateEmployeeAnnualLeave.Enjoyed;
                        AnnualLeave.Remaining = addAuthorizedLeaveViewModel.UpdateEmployeeAnnualLeave.Remaining;
                        SelectedEmployeeAnnualLeave = AnnualLeave;
                        SelectedEmployeeAnnualLeave.TransactionOperation = ModelBase.TransactionOperations.Update;
        ...
        private void PrintEmployeeIdBadgeAction(object obj)
        {
            try
            {
                ...
                List<JobDescription> tempJobDescriptionList = HrmService.GetEmployeeLatestJobDescriptionsByIdEmployee_V2045(employeeDetail.IdEmployee, HrmCommon.Instance.SelectedPeriod);
        ...
        public void AddChangedEmployeeLogDetails()
        {
            try
            {
                ...
                {
                    EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeChangeLogLastDisplayName").ToString(), EmployeeDetail.DisplayName, DisplayName.Trim()) });
                }
                //Display Name Null
                if (string.IsNullOrEmpty(EmployeeDetail.DisplayName) && !string.IsNullOrEmpty(DisplayName))
                {
                    EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeChangeLogLastDisplayName").ToString(), "None", DisplayName.Trim()) });
                }
                //
                if (!string.IsNullOrEmpty(EmployeeDetail.DisplayName) && string.IsNullOrEmpty(DisplayName))
                {
                ...
                if (EmployeeExistDetail.EmployeeAnnualLeaves != EmployeeDetail.EmployeeAnnualLeaves)
                {
                    foreach (EmployeeAnnualLeave annual_leave in UpdatedEmployeeAnnualLeaveList)
                    {
                        if (annual_leave.TransactionOperation == ModelBase.TransactionOperations.Update)
                        {
                            ...
                            if (oldAnnualLeave.AdditionalHoursCount != annual_leave.AdditionalHoursCount)
                            {
                                Int32 oldAnnualLeaveDays = (Int32)(oldAnnualLeave.AdditionalHoursCount / oldAnnualLeave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                Int32 oldAnnualLeaveHours = (Int32)(oldAnnualLeave.AdditionalHoursCount % oldAnnualLeave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);

                                string OldDaysAndHours = oldAnnualLeaveDays + "d" + " " + oldAnnualLeaveHours + "H";

                                Int32 NewAnnualLeaveDays = (Int32)(annual_leave.AdditionalHoursCount / annual_leave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                Int32 NewAnnualLeaveHours = (Int32)(annual_leave.AdditionalHoursCount % annual_leave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                string NewDaysAndHours = NewAnnualLeaveDays + "d" + " " + NewAnnualLeaveHours + "H";

                                EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeAuthorizedLeaveAdditionalHours").ToString(), OldDaysAndHours, NewDaysAndHours) });
                            }
                            if (oldAnnualLeave.RegularHoursCount != annual_leave.RegularHoursCount)
                            {
                                Int32 oldAnnualLeaveDays = (Int32)(oldAnnualLeave.RegularHoursCount / oldAnnualLeave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                Int32 oldAnnualLeaveHours = (Int32)(oldAnnualLeave.RegularHoursCount % oldAnnualLeave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                string OldDaysAndHours = oldAnnualLeaveDays + "d" + " " + oldAnnualLeaveHours + "H";

                                Int32 NewAnnualLeaveDays = (Int32)(annual_leave.RegularHoursCount / annual_leave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                Int32 NewAnnualLeaveHours = (Int32)(annual_leave.RegularHoursCount % annual_leave.Employee.CompanyShift.CompanyAnnualSchedule.DailyHoursCount);
                                string NewDaysAndHours = NewAnnualLeaveDays + "d" + " " + NewAnnualLeaveHours + "H";

                                EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeAuthorizedLeaveRegularHours").ToString(), OldDaysAndHours, NewDaysAndHours) });
                            }
                            if (oldAnnualLeave.CompanyLeave.Name != annual_leave.CompanyLeave.Name)
                            {
                                EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeAuthorizedLeaveType").ToString(), oldAnnualLeave.CompanyLeave.Name, annual_leave.CompanyLeave.Name) });
                            }
                        }
                        ...
                        {
                            EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeAuthorizedLeaveAdd").ToString(), annual_leave.CompanyLeave.Name) });
                        }
                        ...
                        if (annual_leave.TransactionOperation == ModelBase.TransactionOperations.Delete)
                        {
                            ...
                            EmployeeChangeLogList.Add(new EmployeeChangelog() { IdEmployee = EmployeeDetail.IdEmployee, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("EmployeeAuthorizedLeaveDelete").ToString(), annual_leave.CompanyLeave.Name) });
                        }
                    }
                }
                //Employee Shift
        ...
        public void ShowEmployeeIdBadge(Employee EmployeeObj, JobDescription EmployeeJobDescription)
        {
            try
            {
                ...
                employeeIdBadgeReport.xrLblEmployeeLocations.Text = EmployeeIdBadgeObj.CompanyLocation.Alias;
                        ...
                        else
                        {
                            ...
                            if (!HrmCommon.Instance.IsPermissionReadOnly)  // check permission and set Field disable
                            {
                                ...
                                if (ExitEventList.Count > 0)
                                {
                                    ...
                                    if (employeeExitEventObj.ExitDate != null)
                                        tempMinExitEventDate = employeeExitEventObj.ExitDate;
                                }
