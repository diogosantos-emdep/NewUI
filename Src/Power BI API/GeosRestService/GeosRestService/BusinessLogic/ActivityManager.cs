...
namespace BusinessLogic
{
    public class ActivityManager
    {
                        ...
                        if (dr.NextResult())
                        {
                            ...
                            while (dr.Read())
                            {
                                if (dr["IdActivity"] != DBNull.Value)
                                {
                                    ...
                                    {
                                        activity.LinkedAccountGroup = dr["Group"].ToString();
                                        activity.LinkedAccountPlant = dr["CustomerPlantName"].ToString();
                                    }
                                }
                            }
                        }
        ...
        //public List<ActivityLinkedItem> GetActivityLinkedItems(long IdActivity)
        //{
        //    List<ActivityLinkedItem> ActivityLinkedItems = new List<ActivityLinkedItem>();
        //    using (MySqlConnection conn = new MySqlConnection(_ConnString))
        //    {
        //        conn.Open();
        //        MySqlCommand command = new MySqlCommand("GeosApiGetActivityLinkedItem", conn);
        //        command.Parameters.AddWithValue("_IdActivity", IdActivity);
        //        command.CommandType = CommandType.StoredProcedure;
        //        using (MySqlDataReader dr = command.ExecuteReader())
        //        {
        //            while (dr.Read())
        ...
        //                activityLinkedItem.Caroem = dr["Caroem"].ToString();
        //                activityLinkedItem.CarProject = dr["CarProject"].ToString();
        //                activityLinkedItem.Competitor = dr["Competitor"].ToString();
        //                activityLinkedItem.Contact = dr["FirstName"].ToString() + " " + dr["Surname"].ToString();
        //                activityLinkedItem.Oppurtunities = dr["Oppurtunities"].ToString();
