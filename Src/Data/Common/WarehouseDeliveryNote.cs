...
namespace Emdep.Geos.Data.Common
{
    ...
    public class WarehouseDeliveryNote : ModelBase, IDisposable
    {
        ...
        [NotMapped]
        [DataMember]
        public DateTime? DeliveryDateNullable
        {
            get { return deliveryDateNullable; }
            set
            {
                deliveryDateNullable = value;
                OnPropertyChanged("DeliveryDateNullable");
            }
        }
