...
namespace Emdep.Geos.Data.Common
{
    ...
    public class Offer : ModelBase, IDisposable
    {
        ...
        Int32? idSourceNew;
        Int32? idBusinessUnitNew;
        float discount;
        float? discountNullable;
        double otPrice;
        List<EngineeringAnalysis> engineeringAnalysisList;
        Int32? idReporterSource;
        string category1;
        string category2;
        Int32 idProductSubCategory;
        List<Tuple<byte, Int32, string>> offerSplitCodeDictionary;
        byte[] attachmentBytes;
        string attachmentFileName;
        long idSiteCreatedBy;
        #endregion
        ...
        public string CustomerCountry
        {
            ...
            set
            {
                ...
                OnPropertyChanged("CustomerCountry");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public Int32? IdSourceNew
        {
            get { return idSourceNew; }
            set
            {
                idSourceNew = value;
                OnPropertyChanged("IdSourceNew");
            }
        }

        [NotMapped]
        [DataMember]
        public Int32? IdBusinessUnitNew
        {
            get { return idBusinessUnitNew; }
            set
            {
                idBusinessUnitNew = value;
                OnPropertyChanged("idBusinessUnitNew");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public List<EngineeringAnalysis> EngineeringAnalysisList
        {
            get { return engineeringAnalysisList; }
            set
            {
                engineeringAnalysisList = value;
                OnPropertyChanged("EngineeringAnalysisList");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public List<Tuple<byte, Int32, string>> OfferSplitCodeDictionary
        {
            get { return offerSplitCodeDictionary; }
            set
            {
                offerSplitCodeDictionary = value;
                OnPropertyChanged("OfferSplitCodeDictionary");
            }
        }
        ...
        [Column("InitialOfferValue")]
        [DataMember]
        public double InitialOfferValue
        {
            get { return initialOfferValue; }
            set
            {
                initialOfferValue = value;
                OnPropertyChanged("InitialOfferValue");
            }
        }
        private double initialOfferValue;

        [Column("IdJiraCode")]
        [DataMember]
        public int? IdJiraCode
        {
            get { return idJiraCode; }
            set
            {
                idJiraCode = value;
                OnPropertyChanged("IdJiraCode");
            }
        }
        private int? idJiraCode;

        [Column("IdProblem")]
        [DataMember]
        public int? IdProblem
        {
            get { return idProblem; }
            set
            {
                idProblem = value;
                OnPropertyChanged("IdProblem");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public long IDSiteCreatedBy
        {
            get
            {
                return idSiteCreatedBy;
            }

            set
            {
                idSiteCreatedBy = value;
                OnPropertyChanged("IDSiteCreatedBy");
            }
        }
        #endregion
