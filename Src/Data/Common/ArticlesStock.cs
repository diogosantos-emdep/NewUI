...
namespace Emdep.Geos.Data.Common
{
    ...
    public class ArticlesStock : ModelBase, IDisposable
    {
        ...
        double quantityConversionAmount;//[Sudhir.jangra][GEOS2-4859]
        double quantityConversionIncome;//[Sudhir.jangra][GEOS2-4859]
        //double roundedNumber = Math.Round(quantityConversionIncome, 0);
        double quantityConversionOutcome;//[Sudhir.jangra][GEOS2-4859]
        #endregion
        ...
        /// <summary>
        /// Gets Quantity Income
        /// </summary>
        [NotMapped]
        [DataMember]
        public long QuantityIncome
        {
            get
            {
                if (quantity > 0)
        ...
        /// <summary>
        /// Gets Quantity Outcome
        /// </summary>
        [NotMapped]
        [DataMember]
        public long QuantityOutcome
        {
            get
            {
                if (quantity < 0)
        ...
        [NotMapped]
        [DataMember]
        public double QuantityConversionAmount
        {
            get { return quantityConversionAmount; }
            set
            {
                quantityConversionAmount = value;
                OnPropertyChanged("QuantityConversionAmount");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public double QuantityConversionIncome
        {
            get
            {
                return quantityConversionIncome;
            }
            set
            {
                quantityConversionIncome = value;
                OnPropertyChanged("QuantityConversionIncome");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public double QuantityConversionOutcome
        {
            get
            {
                return quantityConversionOutcome;
            }
            set
            {
                quantityConversionOutcome = value;
                OnPropertyChanged("QuantityConversionOutcome");
            }
        }
