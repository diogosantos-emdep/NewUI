...
{
    public class LogNewJobDecription : ModelBase, IDisposable
    {
        #region Fields
        Int64 idChangeLog;
        Int64 idGeosModule;
        ...
        string change;
        string user;
        List<LogNewJobDecription> logEntries;
        
        #endregion
        #region Constructor
        public LogNewJobDecription()
        {
        ...
        [NotMapped]
        [DataMember]
        public List<LogNewJobDecription> LogEntries
        {
            get
            {
                return logEntries;
