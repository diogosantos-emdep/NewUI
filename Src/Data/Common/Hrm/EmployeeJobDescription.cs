...
namespace Emdep.Geos.Data.Common.Hrm
{
    ...
    public class EmployeeJobDescription : ModelBase, IDisposable
    {
        ...
        byte isMainJobDescriptionGreyImageVisible = 0;
        Visibility isMainVisibleGreyImageVisible = Visibility.Hidden;
        #endregion
        ...
        [DataMember]
        public byte IsMainJobDescriptionGreyImageVisible
        {
            get { return isMainJobDescriptionGreyImageVisible; }
            set
            {
                isMainJobDescriptionGreyImageVisible = value;
                OnPropertyChanged("IsMainJobDescriptionGreyImageVisible");
            }
        }
        ...
        [DataMember]
        public Visibility IsMainVisibleGreyImageVisible
        {
            get
            {
                return isMainVisibleGreyImageVisible;
            }

            set
            {
                isMainVisibleGreyImageVisible = value;
                OnPropertyChanged("IsMainVisibleGreyImageVisible");
            }
        }
