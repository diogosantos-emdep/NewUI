...
namespace Emdep.Geos.Data.Common.Hrm
{
    ...
    public class CompanyShift : ModelBase, IDisposable
    {
        ...
        sbyte isInUse;
        string isNightShiftYesNo;
        string shiftInUseYesNo;
        Int32 idType;//[Sudhir.Jangra][GEOS2-4023][19/04/2023]
        string typeValue;//[Sudhir.Jangra][GEOS2-4023][19/04/2023]
        //[cpatil][GEOS2-5640][29/05/2024]
        TimeSpan deductBreakTime;
        bool isDeductBreakTime;
        #endregion
        ...
        public string DisplayName
        {
            get
            {
                ...
                {
                    if (companySchedule != null && companySchedule.Company != null)
                    {
                        value = name + " - " + companySchedule.Company.Alias;
                    }
                    else
                    {
                        value = name;
        ...
        [NotMapped]
        [DataMember]
        public string IsNightShiftYesNo
        {
            get { return isNightShiftYesNo; }
            set
            {
                isNightShiftYesNo = value;
                OnPropertyChanged("IsNightShiftYesNo");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public string ShiftInUseYesNo
        {
            get { return shiftInUseYesNo; }
            set
            {
                shiftInUseYesNo = value;
                OnPropertyChanged("ShiftInUseYesNo");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public TimeSpan DeductBreakTime
        {
            get { return deductBreakTime; }
            set
            {
                deductBreakTime = value;
                OnPropertyChanged("DeductBreakTime");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public bool IsDeductBreakTime
        {
            get { return isDeductBreakTime; }
            set
            {
                isDeductBreakTime = value;
                OnPropertyChanged("IsDeductBreakTime");
            }
        }
        #endregion
