...
{
    public class CommentEntriesByItems: ModelBase, IDisposable
    {
            ...
            CommentEntriesByItems commentEntriesByItems = (CommentEntriesByItems)this.MemberwiseClone();
