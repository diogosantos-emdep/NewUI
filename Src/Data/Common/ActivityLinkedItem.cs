...
{
    [Table("activity_linked_items")]
    [DataContract]
    public class ActivityLinkedItem : ModelBase, IDisposable
    {
        #region Fields
        Int64 idActivityLinkedItem;
        Int64 idActivity;
        ...
        People people;
        ImageSource activityLinkedItemImage;
        bool isVisible = true;
        Int64? idOffer;
        Int32? idEmdepSite;
        Offer offer;
        ...
        public Int64 IdActivityLinkedItem
        {
            get
            {
                return idActivityLinkedItem;
            }

            set
            {
                idActivityLinkedItem = value;
