...
namespace Emdep.Geos.Data.Common
{
    ...
    public class GeosProvider
    {
        ...
        [Column("SSLServiceProviderUrl")]
        [DataMember]
        public string SSLServiceProviderUrl
        {
            get { return sslServiceProviderUrl; }
            set { sslServiceProviderUrl = value; }
        }
