...
namespace Emdep.Geos.Data.Common
{
    ...
    public class MyWarehouse : ModelBase, IDisposable
    {
        ...
        Int64 dynamicMinimumStock;
        Int64 dynamicMaximumStock;
        double frequency;
        double basePrice;
        ...
        [NotMapped]
        [DataMember]
        public long DynamicMinimumStock
        {
            get { return dynamicMinimumStock; }
            set
            {
                dynamicMinimumStock = value;
                OnPropertyChanged("DynamicMinimumStock");
            }
        }
		//[nsatpute][29.08.2025][GEOS2-6505]
        [NotMapped]
        [DataMember]
        public long DynamicMaximumStock
        {
            get { return dynamicMaximumStock; }
            set
            {
                dynamicMaximumStock = value;
                OnPropertyChanged("DynamicMaximumStock");
            }
        }
		//[nsatpute][29.08.2025][GEOS2-6505]
        [NotMapped]
        ...
        [Column("LockedStock")]
        [DataMember]
        public Int64 LockedStock
        {
            get { return lockedStock; }
            set
            {
                lockedStock = value;
                OnPropertyChanged("LockedStock");
            }
        }
