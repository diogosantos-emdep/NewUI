...
namespace Emdep.Geos.Data.Common.SRM
{
    ...
    [DataContract]
    public class WarehousePurchaseOrderItemWithComments : ModelBase, IDisposable
    {
        #region Declaration
        ...
        [NotMapped]
        [DataMember]
        public Article Article_New
        {
            get { return article_New; }
            set
            {
                article_New = value;
                OnPropertyChanged("Article_New");
            }
        }
        ...
        public WarehousePurchaseOrderItemWithComments()
        {
        }
