...
{
    public class CommentEntriesByItemsSRM: ModelBase, IDisposable
    {
            ...
            public CommentEntriesByItemsSRM()
            {
            }
            ...
            CommentEntriesByItemsSRM commentEntriesByItems = (CommentEntriesByItemsSRM)this.MemberwiseClone();

                if (commentEntriesByItems.PeopleCreator != null)
                commentEntriesByItems.PeopleCreator = (People)this.PeopleCreator.Clone();

                return commentEntriesByItems;
            }
