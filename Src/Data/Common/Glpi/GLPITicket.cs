...
namespace Emdep.Geos.Data.Common.Glpi
{
    ...
    public class GlpiTicket
    {
        ...
        public GlpiTicket()
        {
            ...
            this.GlpiLogs = new List<GlpiLog>();
        ...
        [NotMapped]
        [DataMember]
        public string GlpiUserName
        {
            get { return glpiUserName; }
            set { glpiUserName = value; }
        }

        [NotMapped]
        [DataMember]
        public byte[] ZipFileByte
        {
            get { return zipFileByte; }
            set { zipFileByte = value; }
        }
        ...
        [DataMember]
        public virtual List<GlpiLog> GlpiLogs { get; set; }
        #endregion
    }
}
