...
namespace Emdep.Geos.Data.Common
{
    ...
    public class OTAssignedUser : ModelBase, IDisposable
    {
        ...
        [NotMapped]
        [DataMember]
        public bool IsCurrentlyWorkingOnOT
        {
            get { return isCurrentlyWorkingOnOT; }
            set
            {
                isCurrentlyWorkingOnOT = value;
                OnPropertyChanged("IsCurrentlyWorkingOnOT");
            }
        }
        [NotMapped]
        [DataMember]
