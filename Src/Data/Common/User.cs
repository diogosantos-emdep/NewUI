...
namespace Emdep.Geos.Data.Common
{
    ...
    public class User : ModelBase
    {
        ...
        bool isAuthenticatedUsingLDAP;
        [Column("IsAuthenticatedUsingLDAP")]
        [DataMember]
        public bool IsAuthenticatedUsingLDAP
        {
            get
            {
                return isAuthenticatedUsingLDAP;
            }
            set
            {
                isAuthenticatedUsingLDAP = value;
                OnPropertyChanged("IsAuthenticatedUsingLDAP");
            }
        }
