...
namespace Emdep.Geos.Data.Common.PCM
{
    ...
    public class PCMArticleCategory : ModelBase, IDisposable
    {
        ...
        public bool IsBPLArticle
        {
            ...
            {
                isBPLArticle = value;
                OnPropertyChanged("IsBPLArticle");
            }
        }
		...
		//[GEOS2-2571][04.07.2022][rdixit]
        [DataMember]
        public bool IspcmCategoryNOTInUse
        {
            get
            {
                return ispcmCategoryNOTInUse;
            }

            set
            {
                ispcmCategoryNOTInUse = value;
                OnPropertyChanged("IspcmCategoryNOTInUse");
            }
        }
        #endregion
