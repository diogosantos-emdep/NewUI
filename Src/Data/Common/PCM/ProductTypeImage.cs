...
{
    [DataContract]
    public class ProductTypeImage : ModelBase, IDisposable
    {
        #region Fields

        UInt64 idCPTypeImage;
        UInt64 idCPType;
        ...
        [DataMember]
        public UInt64 IdCPTypeImage
        {
            get
            {
                return idCPTypeImage;
            }

            set
            {
                idCPTypeImage = value;
                OnPropertyChanged("IdCPTypeImage");
            }
        }
        ...
        [DataMember]
        public byte[] ProductTypeImageInBytes
        {
            get
            {
                return productTypeImageInBytes;
            }

            set
            {
                productTypeImageInBytes = value;
                OnPropertyChanged("ProductTypeImageInBytes");
            }
        }
