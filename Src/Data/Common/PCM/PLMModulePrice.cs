...
{
    [DataContract]
    public class PLMModulePrice : ModelBase, IDisposable
    {
        #region Declaration
    ...
    //    IdCPType
        ...
        {
            PLMModulePrice pLMModulePrice = (PLMModulePrice)this.MemberwiseClone();
            if (Status != null)
                pLMModulePrice.Status = (LookupValue)this.Status.Clone();

            if (currency != null)
                pLMModulePrice.currency = (Currency)this.currency.Clone();

            if (Rule != null)
                pLMModulePrice.Rule = (LookupValue)this.Rule.Clone();


            return pLMModulePrice;
        }
