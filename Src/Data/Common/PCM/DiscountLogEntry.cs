...
{
    [DataContract]
    public class DiscountLogEntry : ModelBase, IDisposable
    {
        #region Fields

        UInt32 idLogEntryByDiscount;
        ...
        #region Properties
        [DataMember]
        public UInt32 IdLogEntryByDiscount
        {
            get
            {
                return idLogEntryByDiscount;
            }

            set
            {
                idLogEntryByDiscount = value;
                OnPropertyChanged("IdLogEntryByDiscount");
            }
        }

        [DataMember]
        public UInt64 IdCustomerDiscount
        {
            get
            {
