...
namespace Emdep.Geos.Data.Common.PCM
{
    ...
    public class ProductTypes : ModelBase, IDisposable
    {
        ...
        List<SpareParts> sparePartList_Group;
        List<RegionsByCustomer> customerList;
        List<CPLCustomer> customerListByCPType;
        UInt64 idTemplate_old;
        List<ProductTypeCompatibility> productTypeCompatibilityList;
        bool isImageExist = false;//[Sudhir.Jangra][GEOS2-2922][23/03/2023]
        Visibility isImageVisible = Visibility.Hidden;//[Sudhir.Jangra][GEOS2-2922][23/03/2023]
        ProductTypeImage image;//[Sudhir.Jangra][GEOS2-2922][24/03/2023]
        List<ProductTypeImage> imageList;//[Sudhir.Jangra][GEOS2-2922][24/03/2023]
        string imageCount;//[Sudhir.Jangra][GEOS2-2922][24/03/2023]
        private bool isLastUpdate; //[Rupali Sarode][GEOS2-4355][23-05-2023]
        List<Detections> detectionListWithoutGroup;//[Sudhir.jangra][GEOS2-4221]
        List<SpareParts> sparePartsListWithoutGroup;//[Sudhir.jangra][GEOS2-4221]
        List<Options> optionListWithoutGroup;//[Sudhir.jangra][GEOS2-4221]
        int srNO;//[Sudhir.Jangra][GEOS2-4460][26/06/2023]
        bool isChecked;//[Sudhir.Jangra][GEOS2-4460][26/06/2023]
        List<ProductTypeLogEntry> productTypeCommentList;//[Sudhir.Jangra][GEOS2-4935]
        List<PLMModulePrice> notIncludedPLMModuleList;
        List<CustomerPriceLogEntry> customerPriceLogEntryList;
        List<CPLCustomer> customerListByModule;
        int includedCustomer;
        CPLCustomer pCMCustomer;
        List<CPLCustomer> pCMCustomerList;
        List<PLMModulePrice> modifiedPLMModuleList;
        List<BasePriceLogEntry> basePriceLogEntryList;
        List<PLMModulePrice> includedPLMModuleList;
        ...
        [DataMember]
        public List<SpareParts> SparePartsList_Group
        {
            get
            {
                return sparePartList_Group;
            }

            set
            {
                sparePartList_Group = value;
                OnPropertyChanged("SparePartsList_Group");
            }
        }
        ...
        [DataMember]
        public List<CPLCustomer> CustomerListByCPType
        {
            get
            {
                return customerListByCPType;
            }

            set
            {
                customerListByCPType = value;
                OnPropertyChanged("CustomerListByCPType");
            }
        }
        [DataMember]
        ...
        [DataMember]
        System.Drawing.Bitmap mergePDF;
        public System.Drawing.Bitmap MergePDF
        {
            get
            {
                return mergePDF;
            ...
            {
                mergePDF = value;
                OnPropertyChanged("MergePDF");
            }
        }
        [DataMember]//[Sudhir.Jangra][GEOS2-4460][28/06/2023]
        ...
        [DataMember]
        public List<ProductTypeImage> ImageList
        {
        ...
        [DataMember]
        public List<Detections> DetectionListWithoutGroup
        {
            get { return detectionListWithoutGroup; }
            set
            {
                detectionListWithoutGroup = value;
                OnPropertyChanged("DetectionListWithoutGroup");
            }
        }
        //[Sudhir.Jangra][Geos2-4221]
        [DataMember]
        public List<Options> OptionListWithoutGroup
        {
            get { return optionListWithoutGroup; }
            set
            {
                optionListWithoutGroup = value;
                OnPropertyChanged("OptionListWithoutGroup");
            }
        }
        //[Sudhir.Jangra][Geos2-4221]
        [DataMember]
        public List<SpareParts> SparePartListWithoutGroup
        {
            get { return sparePartsListWithoutGroup; }
            set
            {
                sparePartsListWithoutGroup = value;
                OnPropertyChanged("SparePartListWithoutGroup");
            }
        }
        ...
        [DataMember]
        public List<ProductTypeLogEntry> ProductTypeCommentList
        {
            get { return productTypeCommentList; }
            set
            {
                productTypeCommentList = value;
                OnPropertyChanged("ProductTypeCommentList");
            }
        }
      
        [DataMember]
        public List<PLMModulePrice> IncludedPLMModuleList
        {
            get
            {
                return includedPLMModuleList;
            }

            set
            {
                includedPLMModuleList = value;
                OnPropertyChanged("IncludedPLMModuleList");
            }
        }
   
        [DataMember]
        public List<PLMModulePrice> NotIncludedPLMModuleList
        {
            get
            {
                return notIncludedPLMModuleList;
            }

            set
            {
                notIncludedPLMModuleList = value;
                OnPropertyChanged("NotIncludedPLMModuleList");
            }
        }
    
        [DataMember]
        public List<PLMModulePrice> ModifiedPLMModuleList
        {
            get
            {
                return modifiedPLMModuleList;
            }

            set
            {
                modifiedPLMModuleList = value;
                OnPropertyChanged("ModifiedPLMModuleList");
            }
        }
        ...
        [DataMember]
        public List<CPLCustomer> CustomerListByModule
        {
            get
            {
                return customerListByModule;
            }

            set
            {
                customerListByModule = value;
                OnPropertyChanged("CustomerListByModule");
            }
        }
        ...
        public List<CPLCustomer> PCMCustomerList
        {
            ...
            set
            {
                ...
                OnPropertyChanged("PCMCustomerList");
            }
        }
      
        [DataMember]
        public int IncludedCustomer
        {
            get
            {
            ...
            set
            {
                includedCustomer = value;
                OnPropertyChanged("IncludedCustomer");
            }
        }
          
        [DataMember]
        public CPLCustomer PCMCustomer
        {
            get
            {
                return pCMCustomer;
        ...
        public override object Clone()
        {
            ...
            if (SparePartsList_Group != null)
                productTypes.SparePartsList_Group = SparePartsList_Group.Select(x => (SpareParts)x.Clone()).ToList();
            ...
            if (ProductTypeCommentList!=null)
            {
                productTypes.ProductTypeCommentList = ProductTypeCommentList.Select(x => (ProductTypeLogEntry)x.Clone()).ToList();
            }

            if (IncludedPLMModuleList != null)
                productTypes.IncludedPLMModuleList = IncludedPLMModuleList.Select(x => (PLMModulePrice)x.Clone()).ToList();

            if (NotIncludedPLMModuleList != null)
                productTypes.NotIncludedPLMModuleList = NotIncludedPLMModuleList.Select(x => (PLMModulePrice)x.Clone()).ToList();

            if (ModifiedPLMModuleList != null)
                productTypes.ModifiedPLMModuleList = ModifiedPLMModuleList.Select(x => (PLMModulePrice)x.Clone()).ToList();
        ...
        {
            UpdateAllMaxCostFromNullToZero(this.IncludedPLMModuleList);
            UpdateAllMaxCostFromNullToZero(this.NotIncludedPLMModuleList);
        }

        public static void UpdateAllMaxCostFromNullToZero(ProductTypes moduleDetails)
        {
            UpdateAllMaxCostFromNullToZero(moduleDetails.IncludedPLMModuleList);
            UpdateAllMaxCostFromNullToZero(moduleDetails.NotIncludedPLMModuleList);
        }

        public static void UpdateAllMaxCostFromNullToZero(List<PLMModulePrice> PLMModulePriceList)
        {
            if (PLMModulePriceList != null)
            {
                foreach (PLMModulePrice item in PLMModulePriceList)
                {
