...
namespace Emdep.Geos.Data.Common
{
    ...
    public class WarehouseDeliveryNoteItem : ModelBase, IDisposable
    {
        ...
        bool isLocked;//[Sudhir.Jangra][GEOS2-4543]

        UInt32 idLockedReason;//[Sudhir.Jangra][GEOS2-5457]
        string reasonComment;//[Sudhir.Jangra][GEOS2-5457]
        #endregion
        ...
        [NotMapped]
        [DataMember]
        public UInt32 IdLockedReason
        {
            get { return idLockedReason; }
            set
            {
                idLockedReason = value;
                OnPropertyChanged("IdLockedReason");
            }
        }
        //[Sudhir.Jangra][GEOS2-5457]
        [NotMapped]
        ...
        {
            get { return reasonComment; }
            set
            {
                reasonComment = value;
                OnPropertyChanged("ReasonComment");
            }
        }
