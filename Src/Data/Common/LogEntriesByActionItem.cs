...
namespace Emdep.Geos.Data.Common
{
    public class LogEntriesByActionItem : ModelBase, IDisposable
    {
        ...
        bool isRtfText;
        bool isEnabled = true;
        Int32 idUser; //chitra.girigosavi GEOS2-3799 [ACTIONS_REVIEW] ADD “Linked Items” section in “ACTIONS”:
        DateTime? datetime; //chitra.girigosavi GEOS2-3799 [ACTIONS_REVIEW] ADD “Linked Items” section in “ACTIONS”:
        #endregion
