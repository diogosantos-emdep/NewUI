...
namespace Emdep.Geos.Data.Common
{
    ...
    public class ArticleSupplier : ModelBase, IDisposable
    {
        ...
        double longitude;
        string coordinates;
        List<WarehousePurchaseOrder> orders;
        List<ArticleSupplierPlants> plants;
        List<LogEntriesByArticleSuppliers> logEntriesByArticleSuppliers;
        string group;
        Int64 idEnterpriseGroup;
        Group enterpriseGroup;
        Int32 idArticleSupplierType;

        /*Int32 idPaymentTypes*/
        PaymentTerm paymentTerm;
        Int32? idOrderReceptionLookup;
        LookupValue orderreceptionlookup;
        string isActive;
        ...
        string tradeName;//[Sudhir.jangra][GEOS2-4739]
        string contactCount;//[Sudhir.jangra][GEOS2-4739]
        string state;//[Sudhir.jangra][GEOS2-4739]
        DateTime? modificationDate;//[Sudhir.Jangra]
        Site site; // [nsatpute][21-01-2025][GEOS2-5725]
        #endregion
        ...
        [DataMember]
        public List<WarehousePurchaseOrder> Orders
        {
            get { return orders; }
            set
            {
        ...
        [DataMember]
        public List<ArticleSupplierPlants> Plants
        {
            get { return plants; }
            set
            {
        ...
        {
            get { return logEntriesByArticleSuppliers; }
            set
            {
                logEntriesByArticleSuppliers = value;
                OnPropertyChanged("LogEntriesByArticleSuppliers");
            }
        }
        ...
        [NotMapped]
        [DataMember]
        public Group EnterpriseGroup
        {
            get { return enterpriseGroup; }
            set
            {
                enterpriseGroup = value;
                OnPropertyChanged("EnterpriseGroup");
            }
        }
        [Column("IdEnterpriseGroup")]
        [DataMember]
        public Int64 IdEnterpriseGroup
        {
        ...
        [DataMember]
        public LookupValue OrderReceptionLookup
        {
            get { return orderreceptionlookup; }
            set
            {
                orderreceptionlookup = value;
                OnPropertyChanged("OrderReceptionLookup");
            }
        }

        [DataMember]
        public Int32? IdOrderReceptionLookup
        {
            get { return idOrderReceptionLookup; }
            set
            {
                idOrderReceptionLookup = value;
                OnPropertyChanged("IdOrderReceptionLookup");
            }
        }
