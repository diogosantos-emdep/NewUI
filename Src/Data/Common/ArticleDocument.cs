...
namespace Emdep.Geos.Data.Common
{
    ...
    public class ArticleDocument : ModelBase, IDisposable
    {
        ...
        [NotMapped]
        [DataMember]
        public byte[] PCMArticleFileInBytes
        {
            get
            {
                return pCMArticleFileInBytes;
            }

            set
            {
                pCMArticleFileInBytes = value;
                OnPropertyChanged("PCMArticleFileInBytes");
            }
        }
