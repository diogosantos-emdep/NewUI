...
{
    [DataContract]
    public class CustomerPriceLogEntry : ModelBase, IDisposable
    {
        #region Fields

        UInt64 idLogEntryByCustomerPriceList;
        ...
        #region Properties
        [DataMember]
        public UInt64 IdLogEntryByCustomerPriceList
        {
            get
            {
                return idLogEntryByCustomerPriceList;
            }

            set
            {
                idLogEntryByCustomerPriceList = value;
                OnPropertyChanged("IdLogEntryByCustomerPriceList");
            }
        }

        [DataMember]
        public UInt64 IdCustomerPriceList
        {
            get
            {
