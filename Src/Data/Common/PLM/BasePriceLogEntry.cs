...
{
    [DataContract]
    public class BasePriceLogEntry : ModelBase, IDisposable
    {
        #region Fields

        UInt64 idLogEntryByBasePriceList;
        ...
        #region Properties
        [DataMember]
        public UInt64 IdLogEntryByBasePriceList
        {
            get
            {
                return idLogEntryByBasePriceList;
            }

            set
            {
                idLogEntryByBasePriceList = value;
                OnPropertyChanged("IdLogEntryByBasePriceList");
            }
        }

        [DataMember]
        public UInt64 IdBasePriceList
        {
            get
            {
