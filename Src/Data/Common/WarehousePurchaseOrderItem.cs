...
namespace Emdep.Geos.Data.Common
{
    ...
    public class WarehousePurchaseOrderItem : ModelBase, IDisposable
    {
        ...
        decimal totalAmount;
        double totalAmount_New;
        string reference;
        double totalPrice;  //Added by chitra.girigosavi ON [2/04/2024] GEOS2-5406 Changes in Supplier PO Management(2/3)
        ...
        [NotMapped]
        [DataMember]
        public double TotalAmount_New
        {
            get
            {
                return totalAmount_New;
            }

            set
            {
                totalAmount_New = value;
                OnPropertyChanged("TotalAmount_New");
            }
        }
        [NotMapped]
        [DataMember]
        public double TotalPrice    //Added by chitra.girigosavi ON [2/04/2024] GEOS2-5406 Changes in Supplier PO Management(2/3)
        {
