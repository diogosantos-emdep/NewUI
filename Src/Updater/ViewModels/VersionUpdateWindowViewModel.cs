...
namespace Emdep.Geos.Workbench.Downloader.ViewModels
{
    ...
    public class VersionUpdateWindowViewModel : INotifyPropertyChanged
    {
        ...
        public ICommand UpdaterWindowCloseCommand { get; set; } //rajashri GEOS2-2838
        ...
        public VersionUpdateWindowViewModel(bool chkisWorkbench)
        {
            ...
            UpdaterWindowCloseCommand = new RelayCommand(new Action<object>(WindowClose));
            ...
            //workbenchInstalledFolder = @"C:\Program Files (x86)\Emdep\Geos\Workbench\";
            ...
            if (GeosApplication.Instance.ApplicationSettings != null)
            {
                ...
                if (WorkbenchVersionNumber != null)
                {
                    ...
                    if (geosWorkbenchVersionExpiryDate != null && geosWorkbenchVersionExpiryDate.ExpiryDate != null)
                    {
        ...
        //[001][cpatil][2023-10-28][GEOS2-3879]
        public void RestoreButtonProcess()
        {
            ...
            try
            {
                ...
                {
                    //[001]
                    GeosApplication.Instance.Logger.Log(string.Format("Phase 2 Method RestoreButtonProcess - DevExpress.Compression.ZipArchive "), category: Category.Info, priority: Priority.Low);
