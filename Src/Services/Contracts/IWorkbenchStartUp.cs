...
namespace Emdep.Geos.Services.Contracts
{
    ...
    public interface IWorkbenchStartUp
    {
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        [ObsoleteAttribute("This method will be removed after version V2220. Use GetUserModulesPermissions_V2220 instead.")]
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        [ObsoleteAttribute("This method will be removed after version V2400. Use DeleteUserProfileImage_V2400 instead.")]
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        [ObsoleteAttribute("This method will be removed after this version. Use GetAllCompanyByUserId_2680 instead.")]
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        [ObsoleteAttribute("This method will be removed after version V2490. Use GetUserDataFromTheActiveDirectory_V2490 instead.")]
        ...
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2450. Use FileUpload_V2450 instead.")]
        FileReturnMessage FileUpload(FileDetail fileDetail);

        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2450. Use DeleteFile_V2450 instead.")]
        ...
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2450. Use CheckDirectoryExistOrNot_V2450 instead.")]
        ...
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2450. Use CheckFileExistOrNot_V2450 instead.")]
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        UserLoginEntry AddUserLoginEntry_V2210(UserLoginEntry userLoginEntry);


        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<GeosModule> GetUserModulesPermissions_V2220(int idUser);

        //[rdixit][GEOS2-3741][19.06.2023]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        void DeleteUserProfileImage_V2400(User user);
        //[GEOS2-4502][gulab lakade][10 08  2023]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<GeosSettings> GetSelectedGeosSettings_V2420(string SettingName);

        //[GEOS2-5021][10.11.2023][rdixit]
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2460. Use FileUpload_V2460 instead.")]
        FileReturnMessage FileUpload_V2450(FileDetail fileDetail);

        //[GEOS2-5021][10.11.2023][rdixit]
        [OperationContract]
        FileReturnMessage DeleteFile_V2450(FileDetail fileDetail);

        //[GEOS2-5021][10.11.2023][rdixit]
        [OperationContract]
        FileReturnMessage CheckDirectoryExistOrNot_V2450(FileDetail fileDetail);

        //[GEOS2-5021][10.11.2023][rdixit]
        [OperationContract]
        FileReturnMessage CheckFileExistOrNot_V2450(FileDetail fileDetail);

        //[rdixit][28.11.2023][GEOS2-5088]
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2480. Use CopyDirectory_V248 instead.")]
        bool CopyDirectory(string sourcePath, string destinationPath);

        //[rdixit][28.11.2023][GEOS2-5088]
        [OperationContract]
        [ObsoleteAttribute("This method will be removed after version V2480. Use FileUpload_V2480 instead.")]
        FileReturnMessage FileUpload_V2460(FileDetail fileDetail);

        //[rdixit][29.01.2024][GEOS2-5300]
        [OperationContract]
        FileReturnMessage FileUpload_V2480(FileDetail fileDetail);

        //[rdixit][29.01.2024][GEOS2-5300]
        [OperationContract]
        bool CopyDirectory_V2480(string sourcePath, string destinationPath);

        //[Sudhir.Jangra][GEOS2-3418]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        [ObsoleteAttribute("This method will be removed after version V2610. Use GetUserDataFromTheActiveDirectory_V2610 instead.")]
        List<DomainUser> GetUserDataFromTheActiveDirectory_V2490();
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<DomainUser> GetUserDataFromTheActiveDirectory_V2610();
        
        //[pallavi.kale][16.10.2025][GEOS2-9800]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        User GetUserByLoginName_V2680(string login);

        //[pallavi.kale][16.10.2025][GEOS2-10000]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        User GetUserByCode_V2680(string code);
        ...
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<Company> GetAllCompanyByUserId_V2680(Int32 userId);


        //[pallavi.jadhav][Date:20/11/2025][GEOS2-10143]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<GeosModule> GetUserModulesPermissions_V2690(int idUser);
		//[rohit.rathod][27-11-2025][GEOS2-9800]
        [OperationContract]
        [FaultContract(typeof(ServiceException))]
        List<Company> GetPlantListwithISO_V2690(string PlantIds);
    }
}
