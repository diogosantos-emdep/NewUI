...
namespace Emdep.Geos.Modules.PCM.ViewModels
{
    class AddImageInOptionWayDetectionSparePartViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public void EditInit(DetectionImage OptionWayDetectionSparePartImage)
        {
            try
            {
                ...
                if (OptionWayDetectionSparePartImage.Position == 1)
                {
                    ...
                    // IsImageReadOnly = true;//[rdixit][GEOS2-2694][01.08.2022]
                }
        ...
        //                //textEdit.EditValue += filePath.Split('\\').Last() + "; ";
        //                //FileInBytes = 
        //                //ImageName += filePath.Split('\\').Last() + "; ";
        //                FileInfo file = new FileInfo(filePath);
        //                if (file.Extension == ".png" || file.Extension == ".jpg" || file.Extension == ".jpeg" || file.Extension == ".PNG")
        //                {
        //                    ImageName += filePath.Split('\\').Last() + "; ";
        //                    OptionWayDetectionSparePartSavedImageName = file.Name;
        ...
        //                    // ImageName = "";
        //                    IsSave = false;
        //                    CustomMessageBox.Show(string.Format(System.Windows.Application.Current.FindResource("DropImageFileWarningMessage").ToString()), Application.Current.Resources["PopUpWarningColor"].ToString(), CustomMessageBox.MessageImagePath.NotOk, MessageBoxButton.OK);
