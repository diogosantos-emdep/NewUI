...
{
    class EditBasePriceViewModel : ViewModelBase, INotifyPropertyChanged
    {
        #region Service
        ...
        public EditBasePriceViewModel()
        {
            try
            {
                GeosApplication.Instance.Logger.Log("Constructor EditBasePriceViewModel ...", category: Category.Info, priority: Priority.Low);
                ...
                GeosApplication.Instance.Logger.Log("Constructor EditBasePriceViewModel() executed successfully", category: Category.Info, priority: Priority.Low);
            }
            catch (Exception ex)
            {
                if (DXSplashScreen.IsActive) { DXSplashScreen.Close(); }
                GeosApplication.Instance.Logger.Log(string.Format("Error in Constructor EditBasePriceViewModel() - {0}", ex.Message), category: Category.Exception, priority: Priority.Low);
            }
