...
namespace Emdep.Geos.Modules.Warehouse.ViewModels
{
    class AddCommentViewModel : ViewModelBase, INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        Offer selectedWorkOrder;
        List<Offer> workOrderList;
        Visibility isWorkOrderVisible = Visibility.Collapsed;
        ...
        public Stage Stage
        {
            ...
            set
            {
                ...
                if (Stage != null)
                {
                    if (Stage.IdStage == 31)
                    {
                        IsWorkOrderVisible = Visibility.Visible;
                    }
                    else
                    {
                        IsWorkOrderVisible = Visibility.Collapsed;
                    }
                }
        ...
        public List<Stage> StageList
        {
		 ...
		 //[rdixit][30.01.2023][GEOS2-3605]
        public Offer SelectedWorkOrder
        {
            get
            {
        ...
        public List<Offer> WorkOrderList
        {
        ...
        public Visibility IsWorkOrderVisible
        {
            get
            {
            ...
            set
            {
                isWorkOrderVisible = value;
                if (IsWorkOrderVisible == Visibility.Collapsed)
                    SelectedWorkOrder = null;
                OnPropertyChanged(new PropertyChangedEventArgs("IsWorkOrderVisible"));
            }
        }
        #endregion
        ...
        public void Init(ArticleComment SelectedComment)
        {
            ...
            try
            {
                ...
                Stage = StageList.FirstOrDefault(x => x.IdStage == SelectedComment.IdStage);
				 //[rdixit][30.01.2023][GEOS2-3605]
                if (SelectedComment.WorkOrder != null)
                {
                    if(WorkOrderList.FirstOrDefault(x => x.IdOffer == SelectedComment.WorkOrder.IdOffer)!=null)
                       SelectedWorkOrder = WorkOrderList.FirstOrDefault(x => x.IdOffer == SelectedComment.WorkOrder.IdOffer);
                    else
                    {
                        Offer offer = new Offer();
                        offer.IdOffer = SelectedComment.WorkOrder.IdOffer;
                        offer.Code= SelectedComment.WorkOrder.Code;
        ...
        //[rdixit][30.01.2023][GEOS2-3605]
        //[001][cpatil][04.09.2023][GEOS2-4557]
        private void FillWorkOrderList()
        {
            try
            {
                ...
                //[001]
                WorkOrderList = new List<Offer>(WarehouseService.GetPendingWorkOrdersByWarehouse_V2430(WarehouseCommon.Instance.Selectedwarehouse));
            ...
            {
                GeosApplication.Instance.Logger.Log(string.Format("Error in Method FillWorkOrderList() - {0}", ex.Message), category: Category.Exception, priority: Priority.Low);
            }
        }
            ...
            try
            {
                ...
                if (val)
                {
                    if (IsNew)
                    {
                        ...
                        NewComment.WorkOrder = new Offer();
                        NewComment.WorkOrder = SelectedWorkOrder;
                    ...
                    else
                    {
                        ...
                        UpdatedComment.WorkOrder = new Offer();
                        UpdatedComment.WorkOrder = SelectedWorkOrder;
                        if (DateOfExpiry == null)
                        {
