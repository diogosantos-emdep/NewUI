    ...
    public class PurchaseOrderItemDetailsViewModel : NavigationViewModelBase, INotifyPropertyChanged, IDisposable
    {
        ...
        private void DeliveryNoteGridDoubleClickAction(object obj)
        {
            try
            {
                ...
                //WarehouseDeliveryNote wdn = WarehouseService.GetWarehouseDeliveryNoteById_V2440(warehouseDeliveryNote.IdWarehouseDeliveryNote);
                //Shubham[skadam] GEOS2-5226 NO SE PUEDE DESBLOQUEAR UN ALBARÁN DE LA REFERENCIA 02MOTTRONIC 12 01 2024
               // WarehouseDeliveryNote wdn = WarehouseService.GetWarehouseDeliveryNoteById_V2480(warehouseDeliveryNote.IdWarehouseDeliveryNote);
                //[Sudhir.jangra][GEOS2-5457]
                WarehouseDeliveryNote wdn = WarehouseService.GetWarehouseDeliveryNoteById_V2510(warehouseDeliveryNote.IdWarehouseDeliveryNote);
