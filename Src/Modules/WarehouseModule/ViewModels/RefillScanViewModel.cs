    ...
    class RefillScanViewModel : INotifyPropertyChanged
    {
        ...
        private void ScanBarcodeAction(object obj)
        {
            try
            {
                ...
                {
                    //pramod.misal[GEOS2-5067]22.01.2024
                    string upperlocationbarcode = LocationBarcode.ToUpper();
                    if (string.IsNullOrEmpty(upperlocationbarcode))
                    {
                        SetViewInErrorState();
                        return;
                    }
        ...
        /// [004][avpawar][09-06-2021][GEOS2-3097]
        /// </summary>
                ...
                if (WarehouseCommon.Instance.Selectedwarehouse != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(LocationBarcode))
                    {
                        ...
                        if (WarehouseCommon.Instance.IsRefillEmptyLocationsFirst)
                        {
                            ...
                            //[003] Changed service method GetRefillToListByFullNameSortByStock_V2034 to GetRefillToListByFullNameSortByStock_V2080
                            //LocationsToRefillList = WarehouseService.GetRefillToListByFullNameSortByStock_V2080(WarehouseCommon.Instance.Selectedwarehouse, locationBarcode);
                            //[004] Changed service method GetRefillToListByFullNameSortByStock_V2080 to GetRefillToListByFullNameSortByStock_V2160
                            LocationsToRefillList = WarehouseService.GetRefillToListByFullNameSortByStock_V2160(WarehouseCommon.Instance.Selectedwarehouse, locationBarcode);
                        }
                        else
                        {

                            // [002] Changed Service method
                            //[003] Changed service method GetRefillToListByFullName_V2034 to GetRefillToListByFullName_V2080
                            LocationsToRefillList = WarehouseService.GetRefillToListByFullName_V2080(WarehouseCommon.Instance.Selectedwarehouse, locationBarcode);
                    ...
                    else
                    {
                        ...
                        if (WarehouseCommon.Instance.IsRefillEmptyLocationsFirst)
                        {
                            ...
                            // [002] Changed Service method
                            //[003] Changed service method GetRefillToListSortByStock_V2034 to GetRefillToListSortByStock_V2080
                            //LocationsToRefillList = WarehouseService.GetRefillToListSortByStock_V2080(WarehouseCommon.Instance.Selectedwarehouse);
                            //[004] Changed service method GetRefillToListSortByStock_V2080 to GetRefillToListSortByStock_V2150
                            LocationsToRefillList = WarehouseService.GetRefillToListSortByStock_V2150(WarehouseCommon.Instance.Selectedwarehouse);
                        ...
                        else
                        {
                            ...
                            // [002] Changed Service method
                            //[003] Changed service method GetRefillToList_V2034 to GetRefillToList_V2034
                            LocationsToRefillList = WarehouseService.GetRefillToList_V2080(WarehouseCommon.Instance.Selectedwarehouse);
                            LocationsToRefillList = LocationsToRefillList.OrderBy(x => x.FullName).ToList();
                        }
                    }
                }
