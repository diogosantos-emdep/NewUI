...
namespace Emdep.Geos.Modules.SRM
{
    ...
    public sealed class SRMCommon : Prism.Mvvm.BindableBase
    {
        ...
        private List<WarehousePurchaseOrder> lstWarehousePurchaseOrderChecked;
        private List<object> selectedAuthorizedWarehouseList;//[Sudhir.Jangra][GEOS2-4401][02/05/2023]

        public bool IsTimelineOpen;
        private List<Article> articles;//[Sudhir.Jangra][GEOS2-5635]
        private List<Ots> pendingWorkOrdersList;//[Sudhir.Jangra][GEOS2-5636]
        #endregion
        ...
        public List<WarehousePurchaseOrder> LstWarehousePurchaseOrderChecked
        {
            get
            {
                return lstWarehousePurchaseOrderChecked;
            }

            set
            {
                lstWarehousePurchaseOrderChecked = value;
                OnPropertyChanged("LstWarehousePurchaseOrderChecked");
            }
        }
        //[Sudhir.Jangra][GEOS2-4401][02/05/2023]
        public List<object> SelectedAuthorizedWarehouseList
        {
            get
            {
                return selectedAuthorizedWarehouseList;
            }
            set
            {

                selectedAuthorizedWarehouseList = value;
                OnPropertyChanged("SelectedAuthorizedWarehouseList");
            }
        }
        ...
        public List<Ots> PendingWorkOrdersList
        {
            get { return pendingWorkOrdersList; }
            set
            {
                pendingWorkOrdersList = value;
                OnPropertyChanged("PendingWorkOrdersList");
            }
        }
        #endregion
                ...
                if (GeosApplication.Instance.UserSettings != null)
                {
                    ...
                    if (GeosApplication.Instance.UserSettings.ContainsKey("Contact"))
                    {
                        ...
                        if (count == StoredKeys.Count())
                        {
                            ...
                            Views.AddContactView addContactView = new Views.AddContactView();
        ...
        //[Sudhir.Jangra][GEOS-4692][28/08/2023]
