    ...
    public class LeadsPipelineViewModel : NavigationViewModelBase, INotifyPropertyChanged, IDisposable
    {
                ...
                if (GeosApplication.Instance.SelectedPlantOwnerUsersList != null)
                {
                    ...
                    foreach (var itemPlantOwnerUsers in plantOwners)
                    {
                        try
                        {
                            ...
                            #region Previous_Services
                            // OffersByUsers.AddRange(CrmStartUp.GetOffersPipeline_V2110(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, itemPlantOwnerUsers, GeosApplication.Instance.IdUserPermission).ToList());
                            //[rdixit][GEOS2-3514][29-06-2022][Ignore the “To” date in the “OPPORTUNITIES->Pipeline” section]
                            //OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, itemPlantOwnerUsers, GeosApplication.Instance.IdUserPermission).ToList());
                            //Service Updated from GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2360 to GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420 [rdixit][GEOS2-4712][01.08.2023]
                            #endregion                        
                           // OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, itemPlantOwnerUsers, GeosApplication.Instance.IdUserPermission).ToList());

                            //[Sudhir.Jangra][GEOS2-5310]
                            OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2490(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, itemPlantOwnerUsers, GeosApplication.Instance.IdUserPermission).ToList());
                    ...
                    if (GeosApplication.Instance.SelectedSalesOwnerUsersList != null)
                    {
                        ...
                        foreach (var itemCompaniesDetails in GeosApplication.Instance.CompanyList)
                        {
                            try
                            {
                                ...
                                #region Previous_Services
                                //OffersByUsers.AddRange(CrmStartUp.GetOffersPipeline_V2110(GeosApplication.Instance.IdCurrencyByRegion,
                                ...
                                //[rdixit][GEOS2-3514][29-06-2022][Ignore the “To” date in the “OPPORTUNITIES->Pipeline” section]
                                //OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate(GeosApplication.Instance.IdCurrencyByRegion,
                                //                                                             salesOwnersIds, GeosApplication.Instance.ActiveUser.IdUser,
                                //                                                             GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate,
                                //                                                            itemCompaniesDetails, GeosApplication.Instance.IdUserPermission));                              
                                ...
                                //Service Updated from GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2360 to GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420 [rdixit][GEOS2-4712][01.08.2023]
                                #endregion
                                //OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420(GeosApplication.Instance.IdCurrencyByRegion,
                                //                                                       salesOwnersIds, GeosApplication.Instance.ActiveUser.IdUser,
                                //                                                       GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate,
                                //                                                      itemCompaniesDetails, GeosApplication.Instance.IdUserPermission));
                                ...
                                //[Sudhir.Jangra][GEOS2-5310]
                                OffersByUsers.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2490(GeosApplication.Instance.IdCurrencyByRegion,
                                                                                     salesOwnersIds, GeosApplication.Instance.ActiveUser.IdUser,
                                                                                     GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate,
                                                                                    itemCompaniesDetails, GeosApplication.Instance.IdUserPermission));
            ...
            try
            {
                ...
                foreach (var item in GeosApplication.Instance.CompanyList)
                {
                    try
                    {
                        ...
                        #region Previous_Services
                        //offerList.AddRange(CrmStartUp.GetOffersPipeline_V2110(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, item, GeosApplication.Instance.IdUserPermission));
                        //[rdixit][GEOS2-3514][29-06-2022][Ignore the “To” date in the “OPPORTUNITIES->Pipeline” section]
                        //offerList.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, item, GeosApplication.Instance.IdUserPermission));
                        //Service GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2360 updated with GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420                        
                        //[rdixit][GEOS2-4222][01.03.2023]
                        #endregion
                      //  offerList.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2420(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, item, GeosApplication.Instance.IdUserPermission));

                        //[Sudhir.Jangra][GEOS2-5310]

                        offerList.AddRange(CrmStartUp.GetOfferPipelineDatewise_IgnoreOfferCloseDate_V2490(GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.ActiveUser.IdUser.ToString(), GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, item, GeosApplication.Instance.IdUserPermission));
        ...
        private void MouseDoubleClickLeadPipeline(MouseButtonEventArgs obj)
        {
            try
            {
                ...
                if (GeosApplication.Instance.CompanyList.Any(cl => cl.IdCompany.ToString() == ((Offer)pcl.SelectedItem).Site.ConnectPlantId.ToString()))
                {
                    Company company = GeosApplication.Instance.CompanyList.Where(cmp => cmp.ConnectPlantId == ((Offer)pcl.SelectedItem).Site.ConnectPlantId.ToString()).FirstOrDefault();
                ...
                of = CrmStartUpOfferActiveSite.GetOfferDetailsById_V2090(selectedItem.IdOffer, GeosApplication.Instance.ActiveUser.IdUser, GeosApplication.Instance.IdCurrencyByRegion, GeosApplication.Instance.SelectedyearStarDate, GeosApplication.Instance.SelectedyearEndDate, offerActiveSite);
                ...
                if (of != null)
                {
                    ...
                    LostReasonsByOffer lostReasonsByOffer = CrmStartUpOfferActiveSite.GetLostReasonsByOffer(Convert.ToInt64(TempLeadsList[0].IdOffer),
                    ...
                    if (of.GeosStatus.IdSalesStatusType == 4)
                    {
                        ...
                        var ownerInfo = (pcl as FrameworkElement);
                    ...
                    else
                    {
                        ...
                        ListBoxEdit detailView = (ListBoxEdit)(obj.Source);
