...
namespace Emdep.Geos.Modules.Hrm.ViewModels
{
    public class EditCompanyViewModel : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        private ImageSource companyLogo;   //[pallavi.kale][GEOS2-2497][07-03-25]
        ...
        private int selectedBusinessUnitIndex; // [nsatpute][06-01-2025] [GEOS2-6775]
        private bool isBusinessUnitEnable;
        private ObservableCollection<LookupValue> businessCenterList;     //[pallavi.kale][GEOS2-2497][07-03-25]
        private ObservableCollection<LookupValue> companyLogoList;    //[pallavi.kale][GEOS2-2497][07-03-25]
        private int selectedBusinessCenterIndex;   //[pallavi.kale][GEOS2-2497][07-03-25]
        private int selectedCompanyLogoIndex;   //[pallavi.kale][GEOS2-2497][07-03-25]
        private bool isLogo;   //[pallavi.kale][GEOS2-2497][07-03-25]
        private byte[] logoBytes = null;    //[pallavi.kale][GEOS2-2497][07-03-25]
        private bool isLogoChanged;   //[pallavi.kale][GEOS2-2497][07-03-25]
        private byte[] companyLogoInBytes;
        #endregion
        ...
        public List<object> SelectedComapanyTypes
        {
            ...
            set
            {
                ...
                if (SelectedComapanyTypes != null)
                {
                    byte OrganizationSelected = SelectedComapanyTypes.Any(x => x.Equals("Organization")) ? (byte)1 : (byte)0;
                    if (OrganizationSelected == 0)
                    {
                        IsBusinessUnitEnable = false;
                        SelectedBusinessUnitIndex = -1;
                    }
                    else
                    {
                        IsBusinessUnitEnable = true;
                    }
                }
            }
        }
        // [nsatpute][06-01-2025] [GEOS2-6775]
        public bool IsBusinessUnitEnable
        {
            get { return isBusinessUnitEnable; }
            set
            {
                isBusinessUnitEnable = value;
                OnPropertyChanged(new PropertyChangedEventArgs("IsBusinessUnitEnable"));
                OnPropertyChanged(new PropertyChangedEventArgs("SelectedBusinessUnitIndex"));
            }
        }
        ...
        public ImageSource CompanyLogo
        {
            ...
            {
                companyLogo = value;
                OnPropertyChanged(new PropertyChangedEventArgs("CompanyLogo"));
            }
        }
        public bool IsPhoto
        {
        ...
        //[pallavi.kale][GEOS2-2497][07-03-25]
        public ObservableCollection<LookupValue> BusinessCenterList
        {
            get { return businessCenterList; }
            set
            {
                businessCenterList = value;
                OnPropertyChanged(new PropertyChangedEventArgs("BusinessCenterList"));
            }
        }

        //[pallavi.kale][GEOS2-2497][07-03-25]
        public ObservableCollection<LookupValue> CompanyLogoList
        {
            get { return companyLogoList; }
            set
            {
                companyLogoList = value;
                OnPropertyChanged(new PropertyChangedEventArgs("CompanyLogoList"));
            }
        }

        // [nsatpute][06-01-2025] [GEOS2-6775]
        public int SelectedBusinessUnitIndex
        {
            get { return selectedBusinessUnitIndex; }
            set
            {
                selectedBusinessUnitIndex = value;
                OnPropertyChanged(new PropertyChangedEventArgs("SelectedBusinessUnitIndex"));
            }
        }

        //[pallavi.kale][GEOS2-2497][07-03-25]
        public int SelectedBusinessCenterIndex
        {
            get { return selectedBusinessCenterIndex; }
            set
            {
                selectedBusinessCenterIndex = value;
                OnPropertyChanged(new PropertyChangedEventArgs("SelectedBusinessCenterIndex"));
            }
        }

        //[pallavi.kale][GEOS2-2497][07-03-25]
        public int SelectedCompanyLogoIndex
        {
            get { return selectedCompanyLogoIndex; }
            set
            {
                selectedCompanyLogoIndex = value;
                OnPropertyChanged(new PropertyChangedEventArgs("SelectedCompanyLogoIndex"));
            }
        }
        ...
        public bool IsLogo
        {
            ...
            {
                isLogo = value;
                OnPropertyChanged(new PropertyChangedEventArgs("IsLogo"));
            }
        }
        //[pallavi.kale][GEOS2-2497][07-03-25]
        public byte[] LogoBytes
        {
            ...
            {
                logoBytes = value;
                OnPropertyChanged(new PropertyChangedEventArgs("LogoBytes"));
            }
        }
        //[pallavi.kale][GEOS2-2497][07-03-25]
        public bool IsLogoChanged
        {
            get
            {
                return isLogoChanged;
            }

            set
            {
                isLogoChanged = value;
                OnPropertyChanged(new PropertyChangedEventArgs("IsLogoChanged"));
            }
        }
        public byte[] CompanyLogoInBytes
        {
            get { return companyLogoInBytes; }

            set
            {
                companyLogoInBytes = value;
                OnPropertyChanged(new PropertyChangedEventArgs("CompanyLogoInBytes"));
            }
        }
        #endregion
        ...
        public ICommand SelectionLogoChanged { get; set; }
        ...
        public EditCompanyViewModel()
        {
            try
            {
                ...
                SelectionLogoChanged = new RelayCommand(new Action<object>(SelectionLogoChangedAction));
        ...
        public void Init(Company company)
        {
            try
            {
                ...
                FillBusinessUnit();
                FillBusinessCenter();
                WindowHeader = System.Windows.Application.Current.FindResource("EditEntityWindowHeader").ToString();
                ...
                IsStillActive = ExistCompany.IsStillActive;
                ...
                SelectedBusinessUnitIndex = -1; // [nsatpute][06-01-2025] [GEOS2-6775]
                if (existCompany.IdBusinessUnit != -1 && existCompany.IdBusinessUnit != 0)
                {
                    SelectedBusinessUnitIndex = BusinessUnitList.FindIndex(x => x.IdLookupValue == existCompany.IdBusinessUnit);
                }
                ...
                SelectedBusinessCenterIndex = BusinessCenterList.FindIndex(x => x.IdLookupValue == ExistCompany.IdCompanyType);   //[pallavi.kale][GEOS2-2497][07-03-25]
        ...
        private void FillBusinessUnit()
        {
            try
            {
                GeosApplication.Instance.Logger.Log("Method FillBusinessUnit()...", category: Category.Info, priority: Priority.Low);

                IList<LookupValue> tempList = CrmStartUp.GetLookupValues(2);
                BusinessUnitList = new ObservableCollection<LookupValue>(tempList);
                GeosApplication.Instance.Logger.Log("Method FillBusinessUnit()....executed successfully", category: Category.Info, priority: Priority.Low);
            }
            catch (Exception ex)
            {
                GeosApplication.Instance.Logger.Log("Get an error in Method FillBusinessUnit()...." + ex.Message, category: Category.Exception, priority: Priority.Low);
            }
        }
        ...
        private void SaveCompanyInformation(object obj)
        {
            try
            {
                ...
                PropertyChanged(this, new PropertyChangedEventArgs("SelectedBusinessUnitIndex"));
                PropertyChanged(this, new PropertyChangedEventArgs("SelectedBusinessCenterIndex"));   //[pallavi.kale][GEOS2-2497][07-03-25]
                PropertyChanged(this, new PropertyChangedEventArgs("SelectedCompanyLogoIndex"));   //[pallavi.kale][GEOS2-2497][07-03-25]
                ...
                if (IsLogo)
                {
                    LogoBytes = ImageSourceToBytes(CompanyLogo);
                }
                ...
                else if (defaultPhotoSource != CompanyLogo && IsLogo)
                {
                    LogoBytes = LogoBytes;
                    IsImageDeleted = false;
                    Extension = ".png";
                ...
                UpdateComapny = new Company()
                {
                    ...
                    IdBusinessUnit = SelectedBusinessUnitIndex == -1 ? -1 : BusinessUnitList[SelectedBusinessUnitIndex].IdLookupValue, // [nsatpute][06-01-2025] [GEOS2-6775]
                    IdCompanyType = SelectedBusinessCenterIndex == -1 ? -1 : BusinessCenterList[SelectedBusinessCenterIndex].IdLookupValue,    //[pallavi.kale][GEOS2-2497][07-03-25]
                    IdCompanyLogo = SelectedCompanyLogoIndex == -1 ? -1 : CompanyLogoList[SelectedCompanyLogoIndex].IdLookupValue    //[pallavi.kale][GEOS2-2497][07-03-25]
                };
                ...
                //Service UpdateCompany_V2031 updated with UpdateCompany_V2430 by [rdixit][25.08.2023][GEOS2-3483]
                //UpdateComapny = HrmService.UpdateCompany_V2600(UpdateComapny); // [nsatpute][06-01-2025] [GEOS2-6775]
                // IHrmService HrmService = new HrmServiceController("localhost:6699");
                UpdateComapny = HrmService.UpdateCompany_V2620(UpdateComapny);   //[pallavi.kale][GEOS2-2497][07-03-25]
        ...
        public void GetEmdepSiteImage()
        {
            ...
            catch (Exception ex)
            {
                SiteImage = new BitmapImage(new Uri(@"pack://application:,,,/Emdep.Geos.Modules.Hrm;component/Assets/Images/ImageEditLogo.png"));
                IsPhoto = false;
                GeosApplication.Instance.Logger.Log("Get an error in Method GetEmdepSiteImage()...." + ex.Message + GeosApplication.createExceptionDetailsMsg(ex), category: Category.Exception, priority: Priority.Low);
            }
        }
        ...
        public void AddCompanyChangedLogDetails()
        {
            try
            {
                ...
                if (UpdateComapny.IsStillActive != ExistCompany.IsStillActive)
                {
                    if (UpdateComapny.IsStillActive == 1)
                    {
                        CompanyChangeLogList.Add(new CompanyChangelog() { IdCompany = ExistCompany.IdCompany, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("CompanyChangeLogIsStillActivated").ToString(), ExistCompany.Name) });
                    }
                    if (UpdateComapny.IsStillActive == 0)
                    {
                        CompanyChangeLogList.Add(new CompanyChangelog() { IdCompany = ExistCompany.IdCompany, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("CompanyChangeLogIsStillInactivated").ToString(), ExistCompany.Name) });
                    }
                }
                ...
                // [nsatpute][06-01-2025] [GEOS2-6775]
                // Business Unit 
                if (!ExistCompany.IdBusinessUnit.Equals(BusinessUnitList[SelectedBusinessUnitIndex].IdLookupValue))
                {
                    LookupValue oldBusinessUnit = BusinessUnitList.FirstOrDefault(x => x.IdLookupValue == ExistCompany.IdBusinessUnit);
                    CompanyChangeLogList.Add(new CompanyChangelog() { IdCompany = ExistCompany.IdCompany, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("CompanyChangeLogBusinessUnit").ToString(), oldBusinessUnit == null ? "None" : oldBusinessUnit.Value, BusinessUnitList[SelectedBusinessUnitIndex].Value) });
                }
                //[pallavi.kale][GEOS2-2497][07-03-25]
                if (!ExistCompany.IdCompanyType.Equals(BusinessCenterList[SelectedBusinessCenterIndex].IdLookupValue))
                {
                    LookupValue oldCompanyType = BusinessCenterList.FirstOrDefault(x => x.IdLookupValue == ExistCompany.IdCompanyType);
                    CompanyChangeLogList.Add(new CompanyChangelog() { IdCompany = ExistCompany.IdCompany, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("CompanyChangeLogCompanyCenter").ToString(), oldCompanyType == null ? "None" : oldCompanyType.Value, BusinessCenterList[SelectedBusinessCenterIndex].Value) });
                }
                //[pallavi.kale][GEOS2-2497][07-03-25]
                if (!ExistCompany.IdCompanyLogo.Equals(CompanyLogoList[SelectedCompanyLogoIndex].IdLookupValue))
                {
                    LookupValue oldCompanyLogo = CompanyLogoList.FirstOrDefault(x => x.IdLookupValue == ExistCompany.IdCompanyLogo);
                    CompanyChangeLogList.Add(new CompanyChangelog() { IdCompany = ExistCompany.IdCompany, ChangeLogDatetime = GeosApplication.Instance.ServerDateTime, ChangeLogIdUser = GeosApplication.Instance.ActiveUser.IdUser, ChangeLogChange = string.Format(System.Windows.Application.Current.FindResource("CompanyChangeLogCompanyLogo").ToString(), oldCompanyLogo == null ? "None" : oldCompanyLogo.Value, CompanyLogoList[SelectedCompanyLogoIndex].Value) });
                }
        ...
        private void FillBusinessCenter()
        {
            try
            {
                ...
                IList<LookupValue> tempList = CrmStartUp.GetLookupValues(60);
                BusinessCenterList = new ObservableCollection<LookupValue>(tempList.OrderBy(x => x.Position));
            ...
            {
                GeosApplication.Instance.Logger.Log("Get an error in Method FillBusinessCenter()...." + ex.Message, category: Category.Exception, priority: Priority.Low);
            }
        }
        //[pallavi.kale][GEOS2-2497][07-03-25]
		//[nsatpute][11-04-2025][GEOS2-2497]
        private void FillCompanyLogo()
        {
            try
            {
                GeosApplication.Instance.Logger.Log("Method FillCompanyLogo()...", category: Category.Info, priority: Priority.Low);                
                IList<LookupValue> tempList = CrmStartUp.GetLookupValues(175);
                CompanyLogoList = new ObservableCollection<LookupValue>(tempList.OrderBy(x => x.Position));
                SelectedCompanyLogoIndex = CompanyLogoList.FindIndex(x => x.IdLookupValue == ExistCompany.IdCompanyLogo);
                if (ExistCompany.IdCompanyLogo != 0)
                    SelectionLogoChangedAction(null);


                GeosApplication.Instance.Logger.Log("Method FillCompanyLogo()....executed successfully", category: Category.Info, priority: Priority.Low);
            }
            catch (Exception ex)
            {
                GeosApplication.Instance.Logger.Log("Get an error in Method FillCompanyLogo()...." + ex.Message, category: Category.Exception, priority: Priority.Low);
            }
        }

        private void SelectionLogoChangedAction(object obj)
        {
            try
            {
                if (SelectedCompanyLogoIndex != -1)
                {
                    string companyName = companyLogoList[SelectedCompanyLogoIndex].ImageName;
                    //using (WebClient webClient = new WebClient())
                    //{
                    //    CompanyLogoInBytes = webClient.DownloadData($"https://api.emdep.com/GEOS/Images.aspx?FilePath=/Images/Enumerated/{companyName}");
                    //    CompanyLogo = ByteToImage(CompanyLogoInBytes);
                    //}
                    CompanyLogoInBytes = Utility.ImageUtil.GetImageByWebClient($"https://api.emdep.com/GEOS/Images.aspx?FilePath=/Images/Enumerated/{companyName}");
                    CompanyLogo = ByteToImage(CompanyLogoInBytes);
                }
            }
            catch (Exception ex)
        ...
        string IDataErrorInfo.Error
        {
            get
            {
                ...
                string error =
                    ...
                    me[BindableBase.GetPropertyName(() => SelectedBusinessUnitIndex)] + // [nsatpute][06-01-2025] [GEOS2-6775]
                    me[BindableBase.GetPropertyName(() => SelectedBusinessCenterIndex)] +     //[pallavi.kale][GEOS2-2497][07-03-25]
                    me[BindableBase.GetPropertyName(() => SelectedCompanyLogoIndex)];     //[pallavi.kale][GEOS2-2497][07-03-25]
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                string selectedBusinessUnit = BindableBase.GetPropertyName(() => SelectedBusinessUnitIndex); // [nsatpute][06-01-2025] [GEOS2-6775]
                string selectedBusinessCenter = BindableBase.GetPropertyName(() => SelectedBusinessCenterIndex);    //[pallavi.kale][GEOS2-2497][07-03-25]
                string selectedCompanyLogo = BindableBase.GetPropertyName(() => SelectedCompanyLogoIndex);    //[pallavi.kale][GEOS2-2497][07-03-25]
                ...
                // [nsatpute][06-01-2025] [GEOS2-6775]
                if (columnName == selectedBusinessUnit)
                {
                    if (IsBusinessUnitEnable && SelectedBusinessUnitIndex == -1)
                        return CompanyValidation.GetErrorMessage(selectedBusinessUnit, SelectedBusinessUnitIndex);
                }
