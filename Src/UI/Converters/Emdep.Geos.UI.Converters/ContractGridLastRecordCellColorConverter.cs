...
namespace Emdep.Geos.UI.Converters
{
    public class ContractGridLastRecordCellColorConverter : MarkupExtension, IMultiValueConverter
    {
        ...
        /// [002][cpatil][30-03-2022][GEOS2-3496] HRM - Add new data after exit event [#ERF94]
        /// </summary>
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (values[0] != null && values[2]!=null && values[3] !=null )
                    {
                        if (values[1] != System.DBNull.Value && values[2] != System.DBNull.Value && values[3] != System.DBNull.Value)
                        {
                           
                            if (((Int32)values[2] == 136 || (Int32)values[2] == 138) && (Enddate != null && ((DateTime)(Enddate.Date) < Emdep.Geos.UI.Common.GeosApplication.Instance.ServerDateTime.Date)) && (bool)values[3] == false)
                                return true;
                            else if((Enddate != null && ((DateTime)(Enddate.Date) < Emdep.Geos.UI.Common.GeosApplication.Instance.ServerDateTime.Date)) && (bool)values[3] == false)
                                return true;
