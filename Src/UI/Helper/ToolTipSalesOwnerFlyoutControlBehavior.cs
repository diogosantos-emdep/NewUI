...
{
    public class ToolTipSalesOwnerFlyoutControlBehavior : Behavior<GridControl>
    {
        //[pallavi.kale][GEOS2-9792][07.10.2025]
        ...
        public static readonly DependencyProperty FlyoutControlProperty =
            DependencyProperty.Register("FlyoutControl", typeof(FlyoutControl), typeof(ToolTipSalesOwnerFlyoutControlBehavior), new PropertyMetadata(null));
        ...
        private void AssociatedObject_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                var rowData = grid.GetRow(hitInfo.RowHandle) as Company; // Use GridControl, not TableView
                if (rowData?.SalesOwnerListForImages != null && rowData.SalesOwnerListForImages.Count > 0)
                {
                    ...
                    if (cellElement != null)
                    {
                        ...
                        FlyoutControl.DataContext = rowData.SalesOwnerListForImages;
