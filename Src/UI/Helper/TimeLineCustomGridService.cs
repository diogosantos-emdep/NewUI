...
{
    public class TimeLineCustomGridService : ServiceBase, ICustomGridService, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty GridProperty = DependencyProperty.Register("Grid", typeof(GridControl), typeof(TimeLineCustomGridService), null);
        void ICustomGridService.Refresh()
        {
            if (Grid != null)
            {
                //Grid.RefreshData();
                Grid.RestoreLayoutFromXml(TimelineGridSettingFilePath);
