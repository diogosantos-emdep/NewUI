...
namespace Emdep.Geos.UI.ServiceProcess
{
    ...
    public class WorkbenchServiceController : IWorkbenchStartUp
    {
        ...
        public WorkbenchServiceController(string serviceUrl)
        {
            ...
            {
                serviceAddress = serviceUrl + "/WorkbenchStartUp.svc";
            }
            else
            {
            ...
            if (serviceAddress.Contains("https://"))
            {
                ...
                b.MaxBufferPoolSize = int.MaxValue;
                b.BypassProxyOnLocal = false;
                b.ReceiveTimeout = new TimeSpan(4, 10, 0);
                b.SendTimeout = new TimeSpan(4, 1, 0);
                b.ReaderQuotas = new System.Xml.XmlDictionaryReaderQuotas();
                b.ReaderQuotas.MaxDepth = int.MaxValue;
                b.ReaderQuotas.MaxStringContentLength = int.MaxValue;
                b.ReaderQuotas.MaxBytesPerRead = int.MaxValue;
        ...
        public UserLoginEntry AddUserLoginEntry_V2210(UserLoginEntry userLoginEntry)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.AddUserLoginEntry_V2210(userLoginEntry);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<GeosModule> GetUserModulesPermissions_V2220(int idUser)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserModulesPermissions_V2220(idUser);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public void DeleteUserProfileImage_V2400(User user)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                channel.DeleteUserProfileImage_V2400(user);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<GeosSettings> GetSelectedGeosSettings_V2420(string SettingName)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetSelectedGeosSettings_V2420(SettingName);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage FileUpload_V2450(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.FileUpload_V2450(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage DeleteFile_V2450(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.DeleteFile_V2450(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage CheckDirectoryExistOrNot_V2450(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.CheckDirectoryExistOrNot_V2450(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage CheckFileExistOrNot_V2450(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.CheckFileExistOrNot_V2450(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool CopyDirectory(string sourcePath, string destinationPath)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.CopyDirectory(sourcePath, destinationPath);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage FileUpload_V2460(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.FileUpload_V2460(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public FileReturnMessage FileUpload_V2480(FileDetail fileDetail)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.FileUpload_V2480(fileDetail);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool CopyDirectory_V2480(string sourcePath, string destinationPath)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.CopyDirectory_V2480(sourcePath, destinationPath);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DomainUser> GetUserDataFromTheActiveDirectory_V2490()
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserDataFromTheActiveDirectory_V2490();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public bool UserAuthenticate(string userName, string password)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.UserAuthenticate(userName, password);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<DomainUser> GetUserDataFromTheActiveDirectory_V2610()
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserDataFromTheActiveDirectory_V2610();
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public User GetUserByLoginName_V2680(string login)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserByLoginName_V2680(login);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public User GetUserByCode_V2680(string code)
        {
            try
            {
                ...
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserByCode_V2680(code);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Company> GetAllCompanyByUserId_V2680(Int32 userId)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetAllCompanyByUserId_V2680(userId);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<GeosModule> GetUserModulesPermissions_V2690(int idUser)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetUserModulesPermissions_V2690(idUser);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
        ...
        public List<Company> GetPlantListwithISO_V2690(string PlantIds)
        {
            try
            {
                factory = new ChannelFactory<IWorkbenchStartUp>(binding, endPointAddress);
                IWorkbenchStartUp channel = factory.CreateChannel();
                return channel.GetPlantListwithISO_V2690(PlantIds);
            }
            catch (TimeoutException timeProblem)
            {
                if (factory != null)
