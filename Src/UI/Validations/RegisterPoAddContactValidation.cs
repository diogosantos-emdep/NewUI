...
{
    public class RegisterPoAddContactValidation : ValidationRule
    {
        ...
        public static string GetErrorMessage(string fieldName, object fieldValue, object nullValue = null)
        {
            ...
            else if (fieldName == "SelectedSupplierList")
            {
                if (fieldValue == null || string.IsNullOrEmpty(fieldValue.ToString()))
                    errorMessage = string.Format("You cannot leave the {0} field empty.", "EmdepCode");
            }
