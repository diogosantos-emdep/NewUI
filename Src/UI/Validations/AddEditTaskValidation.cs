...
{
    public class AddEditTaskValidation : ValidationRule
    {
        ...
        public static string GetErrorMessage(string fieldName, object fieldValue, object nullValue = null)
        {
            ...
            //if (fieldName == "SelectedBusinessUnit")
            //{
            //    string value = string.Empty;
            //    if (fieldValue != null && fieldValue.GetType().Equals(typeof(LookupValue)))
            //    {
            ...
            //        if (fieldValue == null || string.IsNullOrEmpty(value) || value == "---")
            //            errorMessage = string.Format("You cannot leave the Business Unit field empty.");
            //        else
            //            errorMessage = string.Empty;
            //    }
            //    else if (fieldValue == null)
