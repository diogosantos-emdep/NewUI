...
namespace Emdep.Geos.UI.Validations
{
    public class LocationValidation : ValidationRule
    {
        ...
        public static string GetErrorMessage(string fieldName, object fieldValue, string fieldName1 = null, object fieldValue1 = null, object nullValue = null)
        {
            ...
            if (fieldName == "From"|| fieldName=="To")
            {
                ...
                {
                    if (int.TryParse(fieldValue.ToString(), out int fromValue) &&
             int.TryParse(fieldValue1.ToString(), out int toValue))
                    {
                ...
                else if(fieldValue == null)
                {
                    if (fieldValue1 != null)
                    {
                        errorMessage = string.Format(" You cannot Leave empty field.");
                    }
                    else
                    {
                        errorMessage = string.Format("You cannot Leave field empty.");
                    }
                }
                //else if (fieldValue1 == null)
                //{
                //    errorMessage = string.Format("You cannot Leave To the field empty.");
                //}
                //else
                //{
                //    errorMessage = string.Format("You cannot Leave From And To the field empty.");
                //}
            ...
            //        else
            //        {
            //            errorMessage = string.Format("You cannot Leave From the field empty.");
            //        }
            //    }
            ...
            //}
            if (fieldName == "SelectedLevel")
            {
                if (fieldValue.ToString() == ""|| fieldValue.ToString() == "---")
                    errorMessage = string.Format("You cannot leave the Selected Level field empty.");
            }
            return errorMessage;
        }
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            string error = GetErrorMessage(FieldName, value, FieldName1,value1 );
