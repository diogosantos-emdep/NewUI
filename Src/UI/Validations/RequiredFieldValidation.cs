...
namespace Emdep.Geos.UI.Validations
{
    public class RequiredValidationRule : ValidationRule
    {
        ...
        public static string GetErrorMessage(string fieldName, object fieldValue, object nullValue = null)
        {
            ...
            //[pramod.misal][14.06.2023]
            else if (fieldName == "EditargetAmount")
            {
                if (fieldValue != null && !fieldValue.GetType().Equals(typeof(System.Windows.Data.BindingExpression)))
                {
                    ...
                    errorMessage = string.Format("Warehouse Targets amount must be greater than zero.", fieldName);
                }
            }
            ...
            else if (fieldName == "OfferCloseDate")
            {
                ...
                if ((fieldValue == null || string.IsNullOrEmpty(fieldValue.ToString()))
                    && (Convert.ToInt16(nullValue) != 17 && Convert.ToInt16(nullValue) != 4 && Convert.ToInt16(nullValue) != 19))
                {
                    errorMessage = string.Format("You cannot leave the {0} field empty.", fieldName);
                }
                else if ((Convert.ToInt16(nullValue) != 17 && Convert.ToInt16(nullValue) != 4 && Convert.ToInt16(nullValue) != 19)
            ...
            else if (fieldName == "ProjectName")
            {
                ...
                else if(fieldValue != null && fieldValue.Equals(true))
                    errorMessage = string.Format("Project name must not contain an existing CarOEM");
            }
